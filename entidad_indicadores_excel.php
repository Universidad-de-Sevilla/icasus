...
$excel->getActiveSheet()->setCellValue('B5', 'Código');
$excel->getActiveSheet()->setCellValue('C5', 'Indicador');
$excel->getActiveSheet()->setCellValue('D5', 'Descripciión');
$excel->getActiveSheet()->setCellValue('E5', 'Formulación');
$excel->getActiveSheet()->setCellValue('F5', 'Umbral');
$excel->getActiveSheet()->setCellValue('G5', 'Responsable');
$excel->getActiveSheet()->setCellValue('H5', 'Periodicidad');
$excel->getActiveSheet()->setCellValue('I5', 'Fuente');
$excel->getActiveSheet()->setCellValue('J5', 'Objetivo');
$excel->getActiveSheet()->setCellValue('K5', 'Proceso');
$excel->getActiveSheet()->setCellValue('L5', 'Creación');
$excel->getActiveSheet()->setCellValue('M5', 'Modificación');
