<form action='index.php?page=entidad_poblar&id_entidad={$entidad.id_entidad}' method='post' class='mini' name='busqueda'>
...
<form action='index.php?page=entidad_poblar' method='post' id='formpoblar' name='formpoblar' class='datos'>
