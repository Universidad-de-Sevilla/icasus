...
<div class="row">
    <div class="col-lg-12">
        <h3 title="{$_nombre_pagina}" class="page-header">
            <i class="fa fa-database fa-fw"></i><sub class="fa fa-pencil fa-fw"></sub> {$_nombre_pagina}
        </h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
                            ...
                            <select class="form-control chosen-select" name="id_tipo_agregacion" id="id_tipo_agregacion">
                                {foreach $tipos_agregacion as $tipo_agregacion}
                                    {if $tipo_agregacion->id != 0 AND $tipo_agregacion->id != 5}
                                        <option {if $tipo_agregacion->id == 6 && !$dato->calculo}class="hidden heredado"{else if $tipo_agregacion->id == 6 && $dato->calculo}class="heredado"{else if $tipo_agregacion->id == 4}class="manual"{/if} title="{$tipo_agregacion->explicacion}" value="{$tipo_agregacion->id}" {if $dato->id_tipo_agregacion == $tipo_agregacion->id}selected{/if}>{$tipo_agregacion->descripcion}</option>
                                    {/if}
                                {/foreach}
                            </select>
                        </div>
