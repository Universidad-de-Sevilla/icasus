...
$cod_unidad = filter_input(INPUT_POST, 'unidad');
$periodos = filter_input(INPUT_POST, 'periodo');
$codigos = filter_input(INPUT_POST, 'indicador');
...
$excel->getActiveSheet()->setTitle(FIELD_INFORM);
