{if $contenedor == 'pi'}
	{html_select_date field_order='DMY' prefix="pi" month_format='%m' end_year=$smarty.now|date_format:"%Y"+2 time=$medicion->periodo_inicio}
...
{/if}
{if $contenedor == 'pf'}
	{html_select_date field_order='DMY' prefix="pf" month_format='%m' end_year=$smarty.now|date_format:"%Y"+2 time=$medicion->periodo_fin}
...
{/if}
{if $contenedor == 'gi'}
	{html_select_date field_order='DMY' prefix="gi" month_format='%m' end_year=$smarty.now|date_format:"%Y"+2 time=$medicion->grabacion_inicio}
...
{/if}
{if $contenedor == 'gf'}
	{html_select_date field_order='DMY' prefix="gf" month_format='%m' end_year=$smarty.now|date_format:"%Y"+2 time=$medicion->grabacion_fin}
