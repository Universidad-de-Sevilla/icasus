...
{if $modulo === 'editar_analisis'}
    ...
    <div class="col-sm-2">
        <a id="grabar_analisis" title="{$smarty.const.TXT_GRABAR}" class="btn btn-default btn-danger btn-xs btn-circle" data-id_indicador='{$indicador->id}' data-anyo='{$analisis_actual->anyo}'><i class="fa fa-floppy-o fa-fw"></i></a>
        <a id="cancelar_analisis" title="{$smarty.const.TXT_CANCEL}" class="btn btn-default btn-danger btn-xs btn-circle" data-id_indicador='{$indicador->id}' data-anyo='{$analisis_actual->anyo}'><i class="fa fa-times fa-fw"></i></a>
    </div>
{/if}
...
{if $modulo === 'editar_plan'}
    ...
    <div class="col-sm-2">
        <a id="grabar_plan" title="{$smarty.const.TXT_GRABAR}" class="btn btn-default btn-danger btn-xs btn-circle" data-id_indicador='{$indicador->id}' data-anyo='{$analisis_actual->anyo}'><i class="fa fa-floppy-o fa-fw"></i></a>
        <a id="cancelar_plan" title="{$smarty.const.TXT_CANCEL}" class="btn btn-default btn-danger btn-xs btn-circle" data-id_indicador='{$indicador->id}' data-anyo='{$analisis_actual->anyo}'><i class="fa fa-times fa-fw"></i></a>
    </div>
{/if}
