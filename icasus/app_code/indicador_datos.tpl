...
<a href='index.php?page=indicador_listar&id_entidad={$indicador.id_entidad}'><img 
	src='iconos/16x16/chart_curve.png' /> Listar todos</a> &nbsp;
<a href='index.php?page=indicador_editar&id_indicador={$indicador.id_indicador}&id_entidad={$indicador.id_entidad}'><img 
	src='iconos/16x16/chart_curve_edit.png'  /> Editar</a> &nbsp; 
<a href='index.php?page=indicador_crear&id_entidad={$indicador.id_entidad}'><img 
	src='iconos/16x16/chart_curve_add.png'  /> Crear</a> &nbsp; 
<a
href='index.php?page=indicador_borrar&id_indicador={$indicador.id_indicador}&id_entidad={$indicador.id_entidad}' onClick='return confirmar();'><img 
	src='iconos/16x16/chart_curve_delete.png'  /> Borrar</a> &nbsp; 
...
<table>
	...
	<tr>
		<td><a href='index.php?page=proceso_mostrar&codigo={$indicador.codigo_proceso}' title='Mostrar 
...
<a href='index.php?page=valor_crear&id_indicador={$indicador.id_indicador}&id_entidad={$indicador.id_entidad}'><img 
	src='iconos/16x16/tag_blue_add.png' /> Agregar valor</a>
{if $valores}
	...
	<table class='listing' id='sortable'>
		...
		{foreach from=$valores item=valor}
			...
			- <a
			  href='index.php?page=valor_borrar&id_valor={$valor.id_valor}&id_indicador={$indicador.id_indicador}&id_entidad={$indicador.id_entidad}'
