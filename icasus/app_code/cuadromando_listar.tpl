...
{if $cuadromandos}
 <div class="box grid_16 single_datatable">
    <h2 class="box_head grad_grey_dark"><a href='index.php?page=cuadromando_crear' title="Crear nuevo cuadro de mando"><img 	src='/icons/ff16/table_add.png' alt='icono' /></a> Indicadores a su cargo</h2>
