...
<div class="row">
    <div class="col-lg-12">
        <h3 title="{$_nombre_pagina}" class="page-header">
            <i class="fa fa-th fa-fw"></i><sub class="fa fa-plus-circle fa-fw"></sub> {$_nombre_pagina}
        </h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-12">
        <form action='index.php?page=cuadro_grabar' method='post' id='formcuadro' name='formcuadro' 
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='nombre' id='nombre' placeholder="{$smarty.const.FIELD_NOMBRE_CUADRO}" required/>
