		...
		<div class="block">
			...
			<form method='post' action='index.php?page=proceso_editar' id='formproceso' class='datos'>
			  ...
			  <fieldset class="label_side">
				...
				<div>
					<input style="width:100%" type='text' name='codigo' id='codigo' value='{$proceso->codigo}' />
					<div class="required_tag tooltip hover left" title="Campo requerido"></div>
				</div>
			  </fieldset> 
			  <fieldset class="label_side">
				...
				<div>
					<input style="width:100%" type='text' name='revision' id='revision' value='{$proceso->revision}' />					
					<div class="required_tag tooltip hover left" title="Campo requerido"></div>
				</div>
			  </fieldset>  
			  <fieldset class="label_side">
				<label>Fecha</label>
				<div>
					<input style="width:100%" type='text' name='fecha_revision' id='fecha_revision' value="{$proceso->fecha_revision|date_format:"%d/%m/%Y"}" />
					<div class="required_tag tooltip hover left" title="Campo requerido"></div>
				</div>
			  </fieldset>  
			  <fieldset class="label_side">
				...
				<div>
					<input style="width:100%" type='text' name='nombre' id='nombre' value='{$proceso->nombre}' />
					<div class="required_tag tooltip hover left" title="Campo requerido"></div>
				</div>
			  </fieldset> 
			  <fieldset class="label_side">
