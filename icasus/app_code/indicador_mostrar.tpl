        ...
        <div class="btn-toolbar" role="toolbar" aria-label="">
            <div class="btn-group" role="group" aria-label="">
                {if $_control || $responsable}
                    ...
                    <a title="{$smarty.const.TXT_BORRAR}" class="btn btn-default btn-danger" href='index.php?page=indicador_borrar&id_indicador={$indicador->id}&id_entidad={$indicador->id_entidad}'
                       onClick="return confirm('{$smarty.const.MSG_INDIC_CONFIRM_BORRAR}');">
                        <i class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_BORRAR}
                    </a>
                {/if}
            </div>
            <div class="btn-group" role="group" aria-label="">
