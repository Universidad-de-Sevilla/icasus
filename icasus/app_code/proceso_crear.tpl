...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><a title="{$smarty.const.TXT_PROC_LIST}: {$entidad->nombre}" href='index.php?page=proceso_listar&id_entidad={$entidad->id}'>{$smarty.const.TXT_PROC_LIST}: {$entidad->nombre|truncate:30}</a></li>
                ...
                <form id="proceso_crear" method="post" action="index.php?page=proceso_grabar" data-toggle="validator" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="otros">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">
                                    <button id="btn_prev_proceso" title="{$smarty.const.TXT_ANT}" type="button" class="btn btn-default btn-primary btnPrev">
