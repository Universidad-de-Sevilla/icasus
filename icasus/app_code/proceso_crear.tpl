        ...
        <div class="block">
            ...
            <form method="post" action="index.php?page=proceso_grabar" class="validate_form">
                ...
                <div class="columns clearfix">
                    <div class="col_33">
                        <fieldset>
                            ...
                            <div>
                                <input type="text" name="codigo" placeholder="{$smarty.const.TXT_INDICAR_COD}" class="required" />
                                <div class="required_tag"></div>
                            </div>
                        </fieldset> 
                    </div>
                    <div class="col_33">
                        <fieldset>
                            ...
                            <div>
                                <input type="text" name="revision" placeholder="{$smarty.const.TXT_PROC_VERSION}"  class="required" />
                                <div class="required_tag"></div>
                            </div>
                        </fieldset>  
                    </div>
                    <div class="col_33">
                        <fieldset>
                            ...
                            <div>
                                <input type="text" name="fecha_revision" placeholder="{$smarty.const.TXT_FECHA_REV_ACTUAL}" class="required" />
                                <div class="required_tag"></div>
                            </div>
                        </fieldset>  
                    </div>
                ...
                <div class="button_bar clearfix">
                    ...
                    <button class="light send_right" type="reset" value="{$smarty.const.TXT_CANCEL}" name="proceso_cancel" onclick="history.back();">
                        <div class="ui-icon ui-icon-closethick"></div>
                        <span>{$smarty.const.TXT_CANCEL}</span>
                    </button>
                </div>    
