                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" id="myModalLabel"><i class="fa fa-book fa-fw"></i><sub class="fa fa-pencil fa-fw"></sub> {$smarty.const.TXT_PLAN_EDIT}: {$plan->anyo_inicio} - {$plan->anyo_inicio + $plan->duracion-1}</h3>
                        </div>
