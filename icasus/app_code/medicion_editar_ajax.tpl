{if $modulo == 'editarfila'}
    <table class="static">
        <thead><tr><th>{$smarty.const.FIELD_UNID}</th><th>{$smarty.const.FIELD_VAL}</th><th>{$smarty.const.FIELD_FECHA_RECOGIDA}</th><th>{$smarty.const.FIELD_USER_GRABA}</th></tr></thead>
        <tbody>
...
{if $modulo == 'cancelarvalorreferencia'}
    <a href="javascript:void(0)" onclick="referencia_editar('{$valor_referencia_medicion->id}');">{if $valor_referencia_medicion->valor == NULL}---{else}{$valor_referencia_medicion->valor|round:"2"}{/if}</a>
{/if}
{if $modulo == 'editarvalorreferencia'}
    ...
    <a href="javascript:void(0)" onclick="javascript:referencia_grabar('{$referencia->id}');"><img title='{$smarty.const.TXT_GRABAR}' src='/icons/ff16/disk.png'align="absmiddle"></a></a>
<a href="javascript:void(0)" onclick="javascript:referencia_cancelar('{$referencia->id}');"><img title='{$smarty.const.TXT_CANCEL}' src='/icons/ff16/cross.png'align= "absmiddle"></a></a>
{/if}
...
<a href="javascript:void(0)" onclick="javascript:fecha_grabar('{$medicion->id}', 'pi');"><img title='{$smarty.const.TXT_GRABAR}' src='/icons/ff16/disk.png'align="absmiddle"></a>
<a href="javascript:void(0)" onclick="javascript:fecha_cancelar('pi', '{$medicion->id}');"><img title='{$smarty.const.TXT_CANCEL}' src='/icons/ff16/cross.png'align="absmiddle"></a>
{/if}
{if $contenedor == 'pf'}
    {html_select_date field_order='DMY' prefix="pf" month_format='%m' start_year="-10" end_year="+2" time=$medicion->periodo_fin}
<a href="javascript:void(0)" onclick="javascript:fecha_grabar('{$medicion->id}', 'pf');"><img title='{$smarty.const.TXT_GRABAR}' src='/icons/ff16/disk.png'align="absmiddle"></a>
<a href="javascript:void(0)" onclick="javascript:fecha_cancelar('pf', '{$medicion->id}');"><img title='{$smarty.const.TXT_CANCEL}' src='/icons/ff16/cross.png'align="absmiddle"></a>
{/if}
{if $contenedor == 'gi'}
    {html_select_date field_order='DMY' prefix="gi" month_format='%m' start_year="-10" end_year="+2" time=$medicion->grabacion_inicio}
<a href="javascript:void(0)" onclick="javascript:fecha_grabar('{$medicion->id}', 'gi');"><img title='{$smarty.const.TXT_GRABAR}' src='/icons/ff16/disk.png'align="absmiddle"></a>
<a href="javascript:void(0)" onclick="javascript:fecha_cancelar('gi', '{$medicion->id}');"><img title='{$smarty.const.TXT_CANCEL}' src='/icons/ff16/cross.png'align="absmiddle"></a>
{/if}
{if $contenedor == 'gf'}
    {html_select_date field_order='DMY' prefix="gf" month_format='%m' start_year="-10" end_year="+2" time=$medicion->grabacion_fin}
<a href="javascript:void(0)" onclick="javascript:fecha_grabar('{$medicion->id}', 'gf');"><img title='{$smarty.const.TXT_GRABAR}' src='/icons/ff16/disk.png'align="absmiddle"></a>
<a href="javascript:void(0)" onclick="javascript:fecha_cancelar('gf', '{$medicion->id}');"><img title='{$smarty.const.TXT_CANCEL}' src='/icons/ff16/cross.png'align="absmiddle"></a>
{/if}
{/if}
{if $modulo == 'editaretiqueta'}
<input name="etiqueta" type="text" value="{$medicion->etiqueta}">
<a href="javascript:void(0)" onclick="javascript:etiqueta_editar_grabar('et', '{$medicion->id}', 'etiqueta');"><img title='{$smarty.const.TXT_GRABAR}' src='/icons/ff16/disk.png'align="absmiddle"></a></a>
<a href="javascript:void(0)" onclick="javascript:etiqueta_editar_cancelar('et', '{$medicion->id}');"><img title='{$smarty.const.TXT_CANCEL}' src='/icons/ff16/cross.png'align= "absmiddle"></a></a>
{/if}
