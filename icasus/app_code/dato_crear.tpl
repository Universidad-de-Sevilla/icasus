    ...
    <div class="col-lg-12">
        <div class="btn-toolbar" role="toolbar" aria-label="">
            <div class="btn-group" role="group" aria-label="">
                <a class="btn btn-default btn-danger" href="index.php?page=dato_listar&id_entidad={$entidad->id}" title="{$smarty.const.TXT_DATOS_VOLVER}">
                    <i class="fa fa-arrow-left fa-fw"></i> {$smarty.const.TXT_DATOS_VOLVER}</a>
            </div>
        </div>
    </div>
    <!-- /.col-lg-12 -->
                ...
                <form method="post" action="index.php?page=dato_grabar" id="dato_crear"
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="dato">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">
                                    <button type="button" class="btn btn-default btn-danger" title="{$smarty.const.TXT_CANCEL}" onclick="location.href = 'index.php?page=dato_listar&id_entidad={$entidad->id}';">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <button id="btn_nxt_otros" title="{$smarty.const.TXT_SIG}" type="button" class="btn btn-default btn-primary">
                        ...
                        <div role="tabpanel" class="tab-pane" id="otros">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-8">
                                    <button id="btn_prev_dato" title="{$smarty.const.TXT_ANT}" type="button" class="btn btn-default btn-primary btnPrev">
