...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="tab-content">
                                ...
                                {foreach from=$indicadores_todos item=indicador} 
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {if $_control OR $_usuario->id==$indicador->id_responsable OR $_usuario->id==$indicador->proceso->id_propietario}
            ...
            <div role="tabpanel" class="tab-pane" id="indic_list">
                <!-- Barra de botones -->
                {if $_control}
                ...
                {if $indicadores}
                    <div class="table-responsive">
                        <table id="tabla_indicadores_proc" class="table table-condensed datatable table-striped table-hover">
                            <thead>
                                <tr>   
                ...
                {else}
                    <div class="row">
                        <div class="col-sm-11">
                            <div class="alert alert-info alert-dismissible">
                                <i class="fa fa-info-circle fa-fw"></i> 
                                {$smarty.const.MSG_UNID_NO_INDIC_PROC}
                            </div> 
                        </div>
                        <!-- /.col-sm-11 -->
                        <div class="col-sm-1">
                ...
                {else}
                    <div class="row">
                        <div class="col-sm-11">
                            <div class="alert alert-info alert-dismissible">
                                <i class="fa fa-info-circle fa-fw"></i> 
                                {$smarty.const.MSG_UNID_NO_INDIC_ARCHIVADOS}
                            </div> 
                        </div>
                        <!-- /.col-sm-11 -->
                        <div class="col-sm-1">
