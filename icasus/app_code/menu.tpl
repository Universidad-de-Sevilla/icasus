...
<div id="sidebar">
    ...
    <div class="user_box clearfix">
        ...
        <h2 style="font-size:2em;color:#BF921D">{$smarty.const.TXT_ICASUS}</h2>
        <h3><a style="font-size:1.5em;" title="{$_usuario->login}" href='index.php?page=usuario_mostrar&id_usuario={$_usuario->id}'>{$_usuario->login}</a></h3><br>
        <ul style="margin-left:40%;">
            <li><a title="{$smarty.const.TXT_CERRAR_SESION}" href="index.php?page={$smarty.const.IC_TIPO_LOGIN}&logout=true">{$smarty.const.TXT_CERRAR_SESION}</a></li>
        </ul>
    </div><!-- #user_box -->

    <ul class="side_accordion">
        <li><a title="{$smarty.const.TXT_INICIO}" href='index.php?page=inicio' accesskey='h'><img src='/icons/ff16/house.png' /> {$smarty.const.TXT_INICIO}</a> 
