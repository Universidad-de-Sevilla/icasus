...
//---------------------------------------------------------------------------------------------------
// Proyecto: Icasus 
// Archivo: grafica_indicador_segregado.php
...
if (filter_has_var(INPUT_GET, 'id_indicador') && filter_has_var(INPUT_GET, 'medicion'))
{
//    $id_indicador = sanitize($_REQUEST["id_indicador"], INT);
    $id_indicador = filter_input(INPUT_GET, 'id_indicador', FILTER_SANITIZE_NUMBER_INT);
//    $etiqueta_medicion = sanitize($_REQUEST["medicion"], SQL);
    $etiqueta_medicion = filter_input(INPUT_GET, 'medicion', FILTER_CALLBACK, array("options" => "Util::mysqlCleaner"));
