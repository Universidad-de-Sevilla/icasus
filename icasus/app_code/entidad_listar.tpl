                    ...
                    {foreach from=$entidades_usuario item=entidad}
                        <tr>
                            ...
                            <td>
                                ...
                                <a href='index.php?page=dato_listar&id_entidad={$entidad->entidad->id}'>{$smarty.const.TXT_DATOS}</a>
                                <!--
                    ...
                    {foreach from=$entidades item=entidad}
                        <tr class="gradeX">
                            ...
                            <td>
                                ...
                                <a href='index.php?page=indicador_listar&id_entidad={$entidad->id}'>{$smarty.const.TXT_INDICS}</a> - 
                                <a href='index.php?page=dato_listar&id_entidad={$entidad->id}'>{$smarty.const.TXT_DATOS}</a>
                            </td>
                        </tr>
                    {/foreach}
                </tbody>
