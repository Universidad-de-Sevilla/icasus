        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel"><i
                            class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_PROC_BORRAR}: {$proceso->nombre}</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a title="{$smarty.const.TXT_SI}" class="btn btn-success" name="borrar" id="borrar"
                   href='index.php?page=proceso_borrar&id_proceso={$proceso->id}&id_entidad={$proceso->id_entidad}'><i
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="">
                            <div class="btn-group" role="group" aria-label="">
                                <a title="{$smarty.const.TXT_PRIMER} {$smarty.const.FIELD_PROC}"
                                   class="btn btn-danger btn-xs {if $indice == 0}disabled{/if}"
                                   href='index.php?page=proceso_mostrar&id_entidad={$entidad->id}&id_proceso={$procesos[0]->id}'>
                                    <i class="fa fa-step-backward fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ANT} {$smarty.const.FIELD_PROC}"
                                   class="btn btn-danger btn-xs {if $indice == 0}disabled" href="#"{else}"
                                href='index.php?page=proceso_mostrar&id_entidad={$entidad->id}&id_proceso={$procesos[$indice-1]->id}'{/if}>
                                <i class="fa fa-play fa-rotate-180 fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_SIG} {$smarty.const.FIELD_PROC}"
                                   class="btn btn-danger btn-xs {if $indice == (count($procesos)-1)}disabled"
                                   href="#"{else}"
                                href='index.php?page=proceso_mostrar&id_entidad={$entidad->id}&id_proceso={$procesos[$indice+1]->id}'{/if}>
                                <i class="fa fa-play fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ULTIMO} {$smarty.const.FIELD_PROC}"
                                   class="btn btn-danger btn-xs {if $indice == (count($procesos)-1)}disabled{/if}"
                                   href='index.php?page=proceso_mostrar&id_entidad={$entidad->id}&id_proceso={$procesos[(count($procesos)-1)]->id}'>
    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active">
                <a href="#proc_param" title="{$smarty.const.TXT_FICHA}" aria-controls="{$smarty.const.TXT_FICHA}"
                   role="tab" data-toggle="tab"><i class="fa fa-folder fa-fw"></i> {$smarty.const.TXT_FICHA}</a>
            </li>
            <li role="presentation">
                <a href="#proc_subprocs" title="{$smarty.const.FIELD_SUBPROCS}"
                   aria-controls="{$smarty.const.FIELD_SUBPROCS}" role="tab" data-toggle="tab"><i
                            class="fa fa-gears fa-fw"></i> {$smarty.const.FIELD_SUBPROCS}</a>
            </li>
            <li role="presentation">
                <a href="#proc_indics" title="{$smarty.const.FIELD_INDICS}" aria-controls="{$smarty.const.FIELD_INDICS}"
                   role="tab" data-toggle="tab"><i class="fa fa-dashboard fa-fw"></i><sub
                            class="fa fa-gear fa-fw"></sub> {$smarty.const.FIELD_INDICS}</a>
            </li>
            <li role="presentation">
                <a href="#proc_indics_archivados" title="{$smarty.const.TXT_INDIC_ARCHIVADOS}"
                   aria-controls="{$smarty.const.TXT_INDIC_ARCHIVADOS}" role="tab" data-toggle="tab"><i
                            class="fa fa-dashboard fa-fw"></i><sub
                            class="fa fa-archive fa-fw"></sub> {$smarty.const.TXT_INDIC_ARCHIVADOS}</a>
            </li>
            <li role="presentation">
                <a href="#proc_archivos" title="{$smarty.const.TXT_ARCHIVOS}"
            ...
            <li role="presentation">
                <a href="#proc_flujo" title="{$smarty.const.TXT_PROC_FLUJO}"
                   aria-controls="{$smarty.const.TXT_PROC_FLUJO}" role="tab" data-toggle="tab"><i
                            class="fa fa-random fa-fw"></i> {$smarty.const.TXT_PROC_FLUJO}</a>
            </li>
        </ul>
        <!-- /Nav tabs -->
        <br>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="proc_param">
                        ...
                        <div class="col-lg-12">
                            <div class="alert alert-info alert-dismissible">
                                ...
                                <a title="{$proceso_madre->nombre}"
                                   href="index.php?page=proceso_mostrar&id_proceso={$proceso_madre->id}&id_entidad={$proceso_madre->id_entidad}">{$proceso_madre->nombre}</a>
                            </div>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                ...
                {if $_control || $permiso_proceso}
                    <div id="botones_ficha" class="hidden">
                        <a title="{$smarty.const.TXT_PROC_EDIT}" class="btn btn-danger"
                    ...
                    <div id="botones_subprocs" class="btn-toolbar hidden" role="toolbar" aria-label="">
                        <div class="btn-group" role="group" aria-label="">
                            <a class="btn btn-danger"
                               href="index.php?page=proceso_crear&id_proceso={$proceso->id}&id_entidad={$entidad->id}"
                        ...
                        <table id="tabla_subprocs" class="table datatable table-striped table-hover">
                            ...
                            {foreach from=$subprocesos item=subproceso}
                                <tr>
                                    ...
                                    <td>
                                        <a title="{$subproceso->nombre}"
                                           href="index.php?page=proceso_mostrar&id_proceso={$subproceso->id}&id_entidad={$subproceso->id_entidad}">
                                            {$subproceso->nombre}
                                        </a>
                                    </td>
                                    ...
                                    <td style="font-size: 12px">
                                        <a title="{$smarty.const.TXT_USER_PERFIL}"
                                           href="index.php?page=usuario_mostrar&id_usuario={$subproceso->propietario->id}">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-default btn-circle btn-xs"
                                           ...
                                           href='index.php?page=archivo_gestionar&id_proceso={$subproceso->id}&id_entidad={$subproceso->id_entidad}'>
                                            <i class="fa fa-archive fa-fw"></i>
                                        </a>
                                        {if $_control || $permiso_proceso}
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_EDIT}"
                                               href='index.php?page=proceso_editar&id_proceso={$subproceso->id}&id_entidad={$subproceso->id_entidad}'>
                                                <i class="fa fa-pencil fa-fw"></i>
                                            </a>
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_BORRAR}"
                                               href='index.php?page=proceso_borrar&id_proceso={$subproceso->id}&id_entidad={$subproceso->id_entidad}'
            ...
            <div role="tabpanel" class="tab-pane" id="proc_indics">
                ...
                {if $_control || $permiso_proceso}
                    <div id="botones_indics" class="btn-toolbar hidden" role="toolbar" aria-label="">
                        <div class="btn-group" role="group" aria-label="">
                            <a class="btn btn-danger"
                               href='index.php?page=indicador_crear&id_entidad={$entidad->id}&id_proceso={$proceso->id}'
                               title="{$smarty.const.TXT_INDIC_CREAR}">
                        ...
                        <table id="tabla_indics" class="table datatable table-striped table-hover">
                            ...
                            {foreach from=$indicadores item=indicador}
                                <tr {if isset($status[$indicador->id])}class="{$status[$indicador->id]}"{/if}>
                                    ...
                                    <td style="font-size: 12px">
                                        <a title="{$smarty.const.TXT_USER_PERFIL}"
                                           href='index.php?page=usuario_mostrar&id_usuario={$indicador->id_responsable}'>{$indicador->responsable->nombre} {$indicador->responsable->apellidos}</a>
                                    </td>
                                    <td style="font-size: 12px">
                                        <a title="{$smarty.const.TXT_USER_PERFIL}"
                                    ...
                                    <td>
                                        ...
                                        {if $_control OR $_usuario->id==$indicador->id_responsable OR $permiso_proceso}
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_EDIT}"
                                            ...
                                            <a class="btn btn-default btn-circle btn-xs"
                                               ...
                                               data-toggle="modal" data-target="#dialogo_confirmar_borrado_indicador"
            ...
            <div role="tabpanel" class="tab-pane" id="proc_indics_archivados">
                {if $indicadores_archivados}
                    <div class="table-responsive">
                        <table id="tabla_indicadores_archivados"
                               class="table table-condensed datatable table-striped table-hover">
                            <thead>
                            <tr>
                            ...
                            {foreach from=$indicadores_archivados item=indicador}
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank"
                                           href='index.php?page=indicador_mostrar&id_indicador={$indicador->id}&id_entidad={$entidad->id}'
                                           title="{$indicador->nombre}: {$indicador->descripcion|replace:"\r\n":" "}">
                                            {$indicador->nombre}</a>
                                    </td>
                                    <td>
                                        <a title="{$smarty.const.TXT_PROC_VER}"
                                           href='index.php?page=proceso_mostrar&id_proceso={$indicador->id_proceso}&id_entidad={$entidad->id}'>
                                    ...
                                    <td style="font-size: 12px">
                                        <a title="{$smarty.const.TXT_USER_PERFIL}"
                                           href='index.php?page=usuario_mostrar&id_usuario={$indicador->id_responsable}&id_entidad={$entidad->id}'>
                                            {$indicador->responsable->nombre} {$indicador->responsable->apellidos}</a>
                                    </td>
                                    <td style="font-size: 12px">
                                        <a title="{$smarty.const.TXT_USER_PERFIL}"
                                           href='index.php?page=usuario_mostrar&id_usuario={$indicador->id_responsable_medicion}&id_entidad={$entidad->id}'>
                                            {$indicador->responsable_medicion->nombre} {$indicador->responsable_medicion->apellidos}</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-default btn-circle btn-xs" title="{$smarty.const.TXT_FICHA}"
                                        ...
                                        <a class="btn btn-default btn-circle btn-xs"
                                           title="{$smarty.const.TXT_REP_GRAFIC}" target="_blank"
                                           href='index.php?page=graficas_mostrar&id_indicador={$indicador->id}&id_entidad={$entidad->id}'>
                                            <i class="fa fa-area-chart fa-fw"></i>
                                        </a>
                                        <a class="btn btn-default btn-circle btn-xs"
                                           href='index.php?page=medicion_listar&id_indicador={$indicador->id}&id_entidad={$indicador->id_entidad}'
            ...
            <div role="tabpanel" class="tab-pane" id="proc_flujo">
                {if isset($flujograma)}
                    <img src="index.php?page=archivo_descargar&id={$flujograma->id}"
                         alt="{$smarty.const.TXT_PROC_FLUJO}" class="img-rounded img-responsive" style="margin:0 auto">
                {else}
                    <div class="row">
                        <div class="col-sm-11">
                            <div class="alert alert-info alert-dismissible">
