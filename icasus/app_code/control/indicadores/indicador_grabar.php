...
//---------------------------------------------------------------------------------------------------
// Proyecto: Icasus 
// Archivo: indicadores/indicador_grabar.php
            ...
            if (filter_has_var(INPUT_POST, 'subunidades')) {
                ...
                if ($periodicidad_actual == $indicador->periodicidad) {
                    ...
                    if ($indicador->periodicidad == 'Bienal') {
                        $logicaIndicador->generar_medicion_bienal($indicador, idate('Y'));
                    } else {
                        $logicaIndicador->generar_mediciones_por_anyo($indicador, idate('Y'));
                    }
