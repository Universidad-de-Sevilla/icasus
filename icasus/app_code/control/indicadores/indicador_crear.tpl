            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="indicador">
                    ...
                    <fieldset>
                        ...
                        {/if}
                        <div id="proceso" class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                {else}
                                    <select class="form-control chosen-select" name="id_proceso" id="id_proceso">
                                        <option value="0">{$smarty.const.TXT_INDIC_NO_PROC} ({$smarty.const.FIELD_DATO})</option>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-8">
                                <input type="number" value="{'Y'|date - 4}" id='historicos' name="historicos" class="form-control" placeholder="{$smarty.const.FIELD_HISTORICO}" min='2000' max="{$smarty.now|date_format:'%Y'}" required/>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                            ...
                            <select class="form-control chosen-select" name="id_tipo_agregacion" id="id_tipo_agregacion">
                                {foreach $tipos_agregacion as $tipo_agregacion}
                                    {if $tipo_agregacion->id != 0 AND $tipo_agregacion->id != 5}
                                        <option {if $tipo_agregacion->id == 6}class="hidden heredado"{elseif $tipo_agregacion->id == 4}class="manual"{/if} title="{$tipo_agregacion->explicacion}" value="{$tipo_agregacion->id}" >{$tipo_agregacion->descripcion}</option>
                                    {/if}
                                {/foreach}
                            </select>
                        </div>
