{if $modulo === 'mostrar'}
    <div class="form-horizontal">
        ...
        <div id="plan" class="form-group">
            ...
            <div class="col-sm-6">
                <textarea  class="form-control" id="texto_plan" placeholder="{$smarty.const.TXT_PLAN_ACCION_DESC}" rows="9" readonly>{$analisis_actual->plan_accion}</textarea>
            </div>
            {if $_control || $responsable}
                <div class="col-sm-2">
...
{if $modulo === 'editar_analisis'}
    <label for="analisis" class="col-sm-2 control-label">{$smarty.const.TXT_ANALISIS}</label>
    <div class="col-sm-6">
        <textarea title="{$smarty.const.TXT_ANALISIS_DESC}" class="form-control" id="texto_analisis" placeholder="{$smarty.const.TXT_ANALISIS_DESC}" rows="9">{$analisis_actual->analisis}</textarea>
    </div>
    <div class="col-sm-3">
...
{if $modulo === 'editar_plan'}
    <label for="plan_accion" class="col-sm-2 control-label">{$smarty.const.TXT_PLAN_ACCION} ({$anyo})</label>
    <div class="col-sm-6">
        <textarea  class="form-control" id="texto_plan" placeholder="{$smarty.const.TXT_PLAN_ACCION_DESC}" rows="9">{$analisis_actual->plan_accion}</textarea>
    </div>
    <div class="col-sm-3">
...
{if $modulo === 'actualizar_tabla'}
    ...
    {literal}
        <script>
            //Collapsible panels
            jQuery(function ($) {
                $('#tabla_analisis_plan .panel-heading i.clickable').on("click", function () {
