                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="">
                            <div class="btn-group" role="group" aria-label="">
                                <a title="{$smarty.const.TXT_PRIMER} {$smarty.const.FIELD_INDIC}"
                                   ...
                                   href='index.php?page=medicion_responsable&id_entidad={$entidad->id}&id_indicador={$indicadores[0]->id}'>
                                ...
                                <a title="{$smarty.const.TXT_ULTIMO} {$smarty.const.FIELD_INDIC}"
                                   ...
                                   href='index.php?page=medicion_responsable&id_entidad={$entidad->id}&id_indicador={$indicadores[(count($indicadores)-1)]->id}'>
    ...
    <div class="col-lg-12">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active">
                <a title="{$smarty.const.FIELD_RESP_MED}" href="#"><i
            ...
            <div class="panel panel-red">
                <div class="panel-heading">
                    <span class="panel-title"><i
                                class="fa fa-sitemap fa-fw"></i> {$smarty.const.TXT_UNIDS_MEDS_INDIC}</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {if $indicador_subunidad->entidad->usuario}
                                                <select id="{$indicador_subunidad->id}" name="responsable"
                                                        class="form-control chosen-select identificador">
