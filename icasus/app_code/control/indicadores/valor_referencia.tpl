...
<div class="modal fade" id="crear_referencia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="post" action="" id="formcrearreferencia" name="formcrearreferencia" data-toggle="validator"
                  class="form-horizontal">
                <input type="hidden" name="c-id_indicador" value="{$indicador->id}"/>
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="{$smarty.const.TXT_CERRAR}">
                        <span aria-hidden="true">&times;</span></button>
                    <h3 class="modal-title" id="myModalLabel"><i class="fa fa-tag fa-fw"></i><sub
                                class="fa fa-plus fa-fw"></sub> {$smarty.const.TXT_VAL_REF_CREAR}</h3>
                </div>
                <div class="modal-body">
                    <div class="form-group has-feedback">
                        <label for="c-nombre" class="col-sm-2 control-label"><i title="{$smarty.const.MSG_CAMPO_REQ}"
                                                                                class="fa fa-asterisk fa-fw"></i> {$smarty.const.FIELD_NOMBRE}
                        </label>
                        <div class="col-sm-8">
                            <input title='{$smarty.const.TXT_VAL_REF_NOMBRE}' data-toggle="tooltip"
                                   data-placement="left" type="text" name='c-nombre' id="c-nombre" value=""
                                   class="form-control" placeholder="{$smarty.const.FIELD_NOMBRE}" required/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="form-group has-feedback">
                        <label for="c-etiqueta" class="col-sm-2 control-label"><i title="{$smarty.const.MSG_CAMPO_REQ}"
                                                                                  class="fa fa-asterisk fa-fw"></i> {$smarty.const.FIELD_ETIQUETA}
                        </label>
                        <div class="col-sm-8">
                            <input title="{$smarty.const.TXT_VAL_REF_ETIQ}" data-toggle="tooltip" data-placement="left"
                                   type="text" name='c-etiqueta' id="c-etiqueta" value="" class="form-control"
                                   placeholder="{$smarty.const.FIELD_ETIQUETA}" required/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" title="{$smarty.const.TXT_CANCEL}" class="btn btn-danger"
                            data-dismiss="modal"><i class="fa fa-times fa-fw"></i> {$smarty.const.TXT_CANCEL}</button>
...
<div class="modal fade" id="editar_referencia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="post" action="" id="formeditarreferencia" name="formeditarreferencia" data-toggle="validator"
                  class="form-horizontal">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="{$smarty.const.TXT_CERRAR}">
                        <span aria-hidden="true">&times;</span></button>
                    <h3 class="modal-title" id="myModalLabel"><i class="fa fa-tag fa-fw"></i><sub
                                class="fa fa-pencil fa-fw"></sub> {$smarty.const.TXT_VAL_REF_EDIT}</h3>
                </div>
                <div class="modal-body">
                    <div class="form-group has-feedback">
                        <label for="e-nombre" class="col-sm-2 control-label"><i title="{$smarty.const.MSG_CAMPO_REQ}"
                                                                                class="fa fa-asterisk fa-fw"></i> {$smarty.const.FIELD_NOMBRE}
                        </label>
                        <div class="col-sm-8">
                            <input title='{$smarty.const.TXT_VAL_REF_NOMBRE}' data-toggle="tooltip"
                                   data-placement="left" type="text" name='e-nombre' id="e-nombre" value=""
                                   class="form-control" placeholder="{$smarty.const.FIELD_NOMBRE}" required/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                    ...
                    <div class="form-group has-feedback">
                        <label for="e-etiqueta" class="col-sm-2 control-label"><i title="{$smarty.const.MSG_CAMPO_REQ}"
                                                                                  class="fa fa-asterisk fa-fw"></i> {$smarty.const.FIELD_ETIQUETA}
                        </label>
                        <div class="col-sm-8">
                            <input title="{$smarty.const.TXT_VAL_REF_ETIQ}" data-toggle="tooltip" data-placement="left"
                                   type="text" name='e-etiqueta' id="e-etiqueta" value="" class="form-control"
                                   placeholder="{$smarty.const.FIELD_ETIQUETA}" required/>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button name="valor_editar" id="valor_editar" type="button" title="{$smarty.const.TXT_GRABAR}"
                            data-texto_editar="{$smarty.const.MSG_VAL_REF_EDITADO}" class="btn btn-success"><i
                                class="fa fa-download fa-fw"></i> {$smarty.const.TXT_GRABAR}</button>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel"><i
                            class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_VAL_REF_BORRAR}</h3>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <a title="{$smarty.const.TXT_SI}" class="btn btn-success" name="borrar" id="borrar"
                   onClick="$('#form_val_ref').submit();"><i class="fa fa-check fa-fw"></i> {$smarty.const.TXT_SI}</a>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <h4 class="page-header">
            <div class="row">
                <div class="col-md-10">
                    <i class="fa fa-dashboard fa-fw"></i>{if $indicador->archivado}<sub
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="">
                            <div class="btn-group" role="group" aria-label="">
                                <a title="{$smarty.const.TXT_PRIMER} {$smarty.const.FIELD_INDIC}"
                                   ...
                                   href='index.php?page=valor_referencia&id_entidad={$entidad->id}&id_indicador={$indicadores[0]->id}'>
                                    <i class="fa fa-step-backward fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ANT} {$smarty.const.FIELD_INDIC}"
                                   class="btn btn-danger btn-xs {if $indice == 0}disabled" href="#"{else}"
                                href='index.php?page=valor_referencia&id_entidad={$entidad->id}&id_indicador={$indicadores[$indice-1]->id}'{/if}>
                                ...
                                <a title="{$smarty.const.TXT_ULTIMO} {$smarty.const.FIELD_INDIC}"
                                   ...
                                   href='index.php?page=valor_referencia&id_entidad={$entidad->id}&id_indicador={$indicadores[(count($indicadores)-1)]->id}'>
    ...
    <div class="col-lg-12">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active">
                <a title="{$smarty.const.TXT_VAL_REF}" href="#"><i
    ...
    <div class="col-lg-12">
        ...
        {if $_control && !$indicador->archivado}
            <div id="botones" class="btn-toolbar hidden" role="toolbar" aria-label="">
                <div class="btn-group" role="group" aria-label="">
                    <a href='javascript:void(0)' title="{$smarty.const.TXT_VAL_REF_CREAR}" class="btn btn-danger"
                       data-toggle="modal" data-target="#crear_referencia">
                        <i class="fa fa-tag fa-fw"></i><sub class="fa fa-plus fa-fw"></sub>
                    </a>
                    {if $indicador->valores_referencia}
                        <a href="javascript:void(0)" title="{$smarty.const.TXT_VAL_REF_BORRAR}" class="btn btn-danger"
        ...
        <!-- /Barra de botones -->
        {if $indicador->valores_referencia}
            <form id="form_val_ref"
                  action='index.php?page=valor_referencia&id_indicador={$indicador->id}&id_entidad={$indicador->id_entidad}&borrar'
                  method='post'>
                <div class="table-responsive">
                        ...
                        {foreach from=$indicador->valores_referencia item=item}
                            <tr>
                                {if $_control && !$indicador->archivado}
                                    ...
                                    <td><a href="javascript:void(0)" class="dialog_button" data-toggle="modal"
                                           data-target="#editar_referencia" title="{$smarty.const.TXT_VAL_REF_EDIT}"
                                           id="l-nombre-{$item->id}" value="{$item->nombre}">{$item->nombre}</a></td>
                                    <td><a href="javascript:void(0)" class="dialog_button" data-toggle="modal"
                                           data-target="#editar_referencia" title="{$smarty.const.TXT_VAL_REF_EDIT}"
                                           id="l-etiqueta-{$item->id}" value="{$item->etiqueta}">{$item->etiqueta}</a>
                                    </td>
                                    <td>
                                        <input type="checkbox" class="grafica" data-toggle="toggle"
                                               data-on="{$smarty.const.TXT_SI}"
                                               data-onstyle="success" data-offstyle="danger" data-size="mini"
                                               data-off="{$smarty.const.TXT_NO}" {if $item->grafica}checked{/if}
                                               id="l-grafica-{$item->id}">
                                    </td>
                                    <td>
                                        <input type="checkbox" class="activo" data-toggle="toggle"
                                               data-on="{$smarty.const.TXT_SI}"
                                               data-onstyle="success" data-offstyle="danger" data-size="mini"
                ...
                <div class="col-sm-1">
                    ...
                    {if $_control && !$indicador->archivado}
                        <div id="botones" class="btn-toolbar" role="toolbar" aria-label="">
                            <div class="btn-group" role="group" aria-label="">
                                <a href='javascript:void(0)' title="{$smarty.const.TXT_VAL_REF_CREAR}"
                                   class="btn btn-danger" data-toggle="modal" data-target="#crear_referencia">
                                    <i class="fa fa-tag fa-fw"></i><sub class="fa fa-plus fa-fw"></sub>
                                </a>
                            </div>
                        </div>
