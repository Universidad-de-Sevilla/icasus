...
//---------------------------------------------------------------------------------------------------
// Proyecto: Icasus
// Archivo: indicadores/indicadores.php
...
$indicadores_ctl = $indicador->Find_joined("control=1 AND archivado is NULL");
...
//Indicadores (datos)
$datos = $indicador->Find_joined("id_proceso IS NULL AND control=0 AND archivado is NULL");
$smarty->assign('datos', $datos);

//Indicadores archivados
$indicadores_archivados = $indicador->Find_joined("archivado is NOT NULL");
$smarty->assign('indicadores_archivados', $indicadores_archivados);

//Indicadores bajo la responsabilidad de este usuario
$indicadores_propios = $indicador->Find_joined_ultima_medicion("(id_responsable = $usuario->id OR id_responsable_medicion = $usuario->id) AND archivado IS NULL");
...
$plantilla = 'indicadores/indicadores.tpl';
