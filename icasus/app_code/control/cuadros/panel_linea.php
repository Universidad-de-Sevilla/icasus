...
// Archivo: cuadros/panel_linea.php
// Desarrolladores: Juanan Ruiz (juanan@us.es), Jesus Martin Corredera (jjmc@us.es),
// Joaquín Valonero Zaera (tecnibus1@us.es)
//---------------------------------------------------------------------------------------------------
// Descripcion: Controlador para la creación de paneles de lineas
//---------------------------------------------------------------------------------------------------
...
if (filter_has_var(INPUT_GET, 'id_cuadro') && filter_has_var(INPUT_GET, 'id_entidad'))
{
    ...
    if ($control || $usuario->id == $cuadro->id_usuario)
    {
        ...
        $smarty->assign('_nombre_pagina', TXT_PANEL_CREAR . ': ' . TXT_LINEAS);
        $plantilla = "cuadros/panel_linea.tpl";
    }
    else
    {
        $error = ERR_PERMISOS;
