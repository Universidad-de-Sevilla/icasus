                    ...
                    <div class="col-md-2">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="">
                            <div class="btn-group" role="group" aria-label="">
                                <a title="{$smarty.const.TXT_PRIMER} {$smarty.const.FIELD_USER}" class="btn btn-danger btn-xs {if $indice == 0}disabled{/if}" href='index.php?page=usuario_mostrar&id_usuario={$usuarios[0]->id}'>
                                    <i class="fa fa-step-backward fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ANT} {$smarty.const.FIELD_USER}" class="btn btn-danger btn-xs {if $indice == 0}disabled{/if}" href='index.php?page=usuario_mostrar&id_usuario={$usuarios[$indice-1]->id}'>
                                    <i class="fa fa-play fa-rotate-180 fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_SIG} {$smarty.const.FIELD_USER}" class="btn btn-danger btn-xs {if $indice == (count($usuarios)-1)}disabled{/if}" href='index.php?page=usuario_mostrar&id_usuario={$usuarios[$indice+1]->id}'>
                                    <i class="fa fa-play fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ULTIMO} {$smarty.const.FIELD_USER}" class="btn btn-danger btn-xs {if $indice == (count($usuarios)-1)}disabled{/if}" href='index.php?page=usuario_mostrar&id_usuario={$usuarios[(count($usuarios)-1)]->id}'>
            ...
            <ul class="nav nav-tabs" role="tablist">
                {if $_usuario->id == $persona->id}
                    ...
                    <li role="presentation">
                        <a href="#user_unids" title="{$smarty.const.TXT_USER_UNIDS}" aria-controls="{$smarty.const.TXT_USER_UNIDS}" role="tab" data-toggle="tab"><i class="fa fa-sitemap fa-fw"></i><sub class="fa fa-user fa-fw"></sub> {$smarty.const.TXT_USER_UNIDS}</a>
                    </li>
                    <li role="presentation">
                ...
                {else}
                    ...
                    <li role="presentation">
                        <a href="#user_unids" title="{$smarty.const.FIELD_UNIDS}" aria-controls="{$smarty.const.FIELD_UNIDS}" role="tab" data-toggle="tab"><i class="fa fa-sitemap fa-fw"></i><sub class="fa fa-user fa-fw"></sub> {$smarty.const.FIELD_UNIDS}</a>
                    </li>
                    <li role="presentation">
                        <a href="#user_procs" title="{$smarty.const.FIELD_PROCS}" aria-controls="{$smarty.const.FIELD_PROCS}" role="tab" data-toggle="tab"><i class="fa fa-gears fa-fw"></i><sub class="fa fa-user fa-fw"></sub> {$smarty.const.FIELD_PROCS}</a>
                    </li>
                    <li role="presentation">
                        <a href="#user_indic" title="{$smarty.const.FIELD_INDICS}" aria-controls="{$smarty.const.FIELD_INDICS}" role="tab" data-toggle="tab"><i class="fa fa-dashboard fa-fw"></i><sub class="fa fa-user fa-fw"></sub> {$smarty.const.FIELD_INDICS}</a>
                    </li>
                    <li role="presentation">
                        <a href="#user_cuadro" title="{$smarty.const.FIELD_CUADROS_MANDO}" aria-controls="{$smarty.const.FIELD_CUADROS_MANDO}" role="tab" data-toggle="tab"><i class="fa fa-th fa-fw"></i><sub class="fa fa-user fa-fw"></sub> {$smarty.const.FIELD_CUADROS_MANDO}</a>
                    </li>
                    <li role="presentation">
                        <a href="#user_objops" title="{$smarty.const.FIELD_OBJS_OP}" aria-controls="{$smarty.const.FIELD_OBJS_OP}" role="tab" data-toggle="tab"><i class="fa fa-bullseye fa-fw"></i><sub class="fa fa-user fa-fw"></sub> {$smarty.const.FIELD_OBJS_OP}</a>
                    </li>
                {/if}
            </ul>
            <!-- /Nav tabs -->
                                    ...
                                    {foreach from=$persona->entidades item=entidad}
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-default btn-circle btn-xs" title="{$smarty.const.FIELD_CARTAS}" href='index.php?page=carta_listar&id_entidad={$entidad->entidad->id}'><i class="fa fa-map-o fa-fw"></i></a>
                                ...
                                <tbody>
                                    {foreach from=$cuadros_propios item=cuadro}
                                        <tr>
                                            ...
                                            <td style="white-space:nowrap">
                                                <a class="btn btn-default btn-circle btn-xs" title="{$smarty.const.TXT_VER}" href="index.php?page=cuadro_mostrar&id={$cuadro->id}&id_entidad={$cuadro->id_entidad}"><i class="fa fa-th fa-fw"></i></a>                 
