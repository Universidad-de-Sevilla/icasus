...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation">
                <a href="#objest_res" title="{$smarty.const.TXT_SEGUIMIENTO}" aria-controls="{$smarty.const.TXT_SEGUIMIENTO}" role="tab" data-toggle="tab"><i class="fa fa-tasks fa-fw"></i> {$smarty.const.TXT_SEGUIMIENTO}</a>
            </li>
        </ul>
        <!-- /Nav tabs -->
        <br>
                                ...
                                <tr>
                                    ...
                                    {if $_control}
                                        <td style="white-space:nowrap" id="edicion_{$i}">
                                            <a title="{$smarty.const.TXT_EDIT}" class="btn btn-default btn-xs btn-circle editar" data-id_objest='{$objest->id}' data-anyo='{$i}'>
                                                <i class="fa fa-pencil fa-fw"></i>
                                            </a>
                                        </td>
                                    {/if}
