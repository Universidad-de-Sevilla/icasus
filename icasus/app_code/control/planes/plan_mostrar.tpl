    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel"><i class="fa fa-book fa-fw"></i> {$_nombre_pagina}</h3>
            </div>
    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active">
                <a href="#plan_ficha" title="{$smarty.const.TXT_FICHA}" aria-controls="{$smarty.const.TXT_FICHA}"
                   role="tab" data-toggle="tab"><i class="fa fa-folder fa-fw"></i> {$smarty.const.TXT_FICHA}</a>
            </li>
            <li role="presentation">
                <a href="#plan_lineas" title="{$smarty.const.FIELD_LINEAS}" aria-controls="{$smarty.const.FIELD_LINEAS}"
                   role="tab" data-toggle="tab"><i
                            class="fa fa-long-arrow-right fa-fw"></i> {$smarty.const.FIELD_LINEAS}</a>
            </li>
            <li role="presentation">
                <a href="#plan_objest" title="{$smarty.const.FIELD_OBJS_EST}"
                   aria-controls="{$smarty.const.FIELD_OBJS_EST}" role="tab" data-toggle="tab"><i
                            class="fa fa-dot-circle-o fa-fw"></i> {$smarty.const.FIELD_OBJS_EST}</a>
            </li>
            <li role="presentation">
                <a href="#plan_objop" title="{$smarty.const.FIELD_OBJS_OP}"
            ...
            <li role="presentation">
                <a href="#plan_res"
                   title="{$smarty.const.TXT_SEGUIMIENTO} ({$smarty.const.FIELD_LINEAS}, {$smarty.const.FIELD_OBJS_EST}, {$smarty.const.FIELD_OBJS_OP})"
                   aria-controls="{$smarty.const.TXT_SEGUIMIENTO} ({$smarty.const.FIELD_LINEAS}, {$smarty.const.FIELD_OBJS_EST}, {$smarty.const.FIELD_OBJS_OP})"
                   role="tab" data-toggle="tab"><i class="fa fa-tasks fa-fw"></i> {$smarty.const.TXT_SEGUIMIENTO}</a>
            </li>
            <li role="presentation">
                <a href="#plan_archivos" title="{$smarty.const.TXT_ARCHIVOS}"
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-hover ficha">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="progress">
                                        <div class="progress-bar {if $plan->ejecucion|round:"2" < 25}progress-bar-danger{elseif $plan->ejecucion|round:"2" >= 25 && $plan->ejecucion|round:"2" < 75}progress-bar-warning{elseif $plan->ejecucion|round:"2" == 100}progress-bar-success{/if}"
                                             role="progressbar" aria-valuenow="{$plan->ejecucion|round:"2"}"
                                             aria-valuemin="0" aria-valuemax="100"
                                             style="min-width: 4em;width:{$plan->ejecucion|round:"2"}%">
                    ...
                    <li class="list-group-item list-group-item-info">
                        <div class="row">
                            <div class="col-sm-8 h4">
                                {$smarty.const.FIELD_PLAN} {$plan->anyo_inicio}
                                - {($plan->anyo_inicio + $plan->duracion-1)}
                            </div>
                            <!-- /.col-sm-8 -->
                            <div class="col-sm-4">
                                <div class="progress">
                            ...
                            {foreach from=$lineas item=linea}
                                <tr>
                                    ...
                                    <td style="white-space:nowrap">
                                        <div class="progress">
                                            <div class="progress-bar {if $linea->ejecucion|round:"2" < 25}progress-bar-danger{elseif $linea->ejecucion|round:"2" >= 25 && $linea->ejecucion|round:"2" < 75}progress-bar-warning{elseif $linea->ejecucion|round:"2" == 100}progress-bar-success{/if}"
                                                 role="progressbar" aria-valuenow="{$linea->ejecucion|round:"2"}"
                                                 aria-valuemin="0" aria-valuemax="100"
                                                 style="min-width: 4em;width:{$linea->ejecucion|round:"2"}%">
                                    ...
                                    <td>
                                        ...
                                        {if $_control}
                                            ...
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_LINEA_BORRAR}" href='javascript:void(0)'
                                               data-toggle="modal" data-target="#dialogo_confirmar_borrado_linea"
                                               data-id_entidad="{$plan->id_entidad}"
                                               data-nombre="{$linea->indice}. {$linea->nombre}"
                                               data-id_linea="{$linea->id}">
                                                <i class="fa fa-trash fa-fw"></i>
                                            </a>
                                        {/if}
                                    </td>
                        ...
                        <table id="tabla_objest" class="table datatable table-striped table-hover">
                            ...
                            {foreach from=$objests item=objest}
                                <tr>
                                    ...
                                    <td style="width:2%">
                                        <span class="label label-default">{$objest->linea->indice}
                                            .{$objest->indice}</span>
                                    </td>
                                    <td style="width:30%">
                                        <a title="{$smarty.const.TXT_FICHA}"
                                    ...
                                    <td>
                                        ...
                                        {if $_control}
                                            ...
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_OBJEST_BORRAR}" href='javascript:void(0)'
                                               data-toggle="modal" data-target="#dialogo_confirmar_borrado_objest"
                                               data-id_entidad="{$plan->id_entidad}"
                                               data-nombre="{$objest->linea->indice}.{$objest->indice}. {$objest->nombre}"
                                               data-id_objest="{$objest->id}">
                                                <i class="fa fa-trash fa-fw"></i>
                                            </a>
                                        {/if}
                                    </td>
                        ...
                        <div class="col-lg-12">
                            <div class="form-horizontal">
                                <div class="form-group h4">
                                    ...
                                    <div class='col-sm-2'>
                                        <a class='btn btn-primary' title="{$smarty.const.TXT_RESUL}"
                                           href="#ejec_anyo">{$smarty.const.TXT_RESUL}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-group" id="accordion_lineas" role="tablist" aria-multiselectable="true"
                            ...
                            {foreach from=$lineas item=linea}
                                <div class="panel panel-danger" style="margin-top: 0;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <h4 class="panel-title">
                                                    <a title="{$smarty.const.FIELD_LINEA}: {$linea->indice}. {$linea->nombre}"
                                                       ...
                                                       data-parent="#accordion_lineas" href="#{$linea->id}"
                                                       aria-expanded="false" aria-controls="">
                                                        <i class="fa fa-long-arrow-right fa-fw"></i> {$linea->indice}
                                                        . {$linea->nombre}
                                                    </a>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="progress">
                                                    <div class="progress-bar {if $linea->ejecucion|round:"2" < 25}progress-bar-danger{elseif $linea->ejecucion|round:"2" >= 25 && $linea->ejecucion|round:"2" < 75}progress-bar-warning{elseif $linea->ejecucion|round:"2" == 100}progress-bar-success{/if}"
                                                         role="progressbar"
                                                         aria-valuenow="{$linea->ejecucion|round:"2"}" aria-valuemin="0"
                                                         aria-valuemax="100"
                                                         style="min-width: 4em;width: {$linea->ejecucion|round:"2"}%;">
                                                        {$linea->ejecucion|round:"2"} %
                                                    </div>
                                    ...
                                    <!-- /.panel-heading -->
                                    <div id="{$linea->id}" class="panel-collapse collapse" role="tabpanel"
                                         aria-labelledby="">
                                        <div class="panel-group" id="accordion_objests" role="tablist"
                                                    ...
                                                    <div class="panel panel-warning" style="margin-top: 0;">
                                                        <div class="panel-heading" role="tab">
                                                            <div class="row">
                                                                <div class="col-sm-8">
                                                                    <h4 class="panel-title">
                                                                        <a title="{$smarty.const.FIELD_OBJ_EST}: {$linea->indice}.{$objest->indice}. {$objest->nombre}"
                                                                           role="button" data-toggle="collapse"
                                                                           data-parent="#accordion_objests"
                                                                           href="#{$linea->id}{$objest->id}"
                                                                           aria-expanded="false" aria-controls="">
                                                                            <i class="fa fa-dot-circle-o fa-fw"></i> {$linea->indice}
                                                                            .{$objest->indice}. {$objest->nombre}
                                                                        </a>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="progress">
                                                                        <div class="progress-bar {if $objest->ejecucion|round:"2" < 25}progress-bar-danger{elseif $objest->ejecucion|round:"2" >= 25 && $objest->ejecucion|round:"2" < 75}progress-bar-warning{elseif $objest->ejecucion|round:"2" == 100}progress-bar-success{/if}"
                                                                             role="progressbar"
                                                                             aria-valuenow="{$objest->ejecucion|round:"2"}"
                                                                             aria-valuemin="0" aria-valuemax="100"
                                                                             style="min-width: 4em;width: {$objest->ejecucion|round:"2"}%;">
                                                                            {$objest->ejecucion|round:"2"} %
                                                                        </div>
                                                        ...
                                                        <!-- /.panel-heading -->
                                                        <div id="{$linea->id}{$objest->id}"
                                                             class="panel-collapse collapse" role="tabpanel"
                                                             aria-labelledby="">
                                                            <div class="panel-group" id="accordion_objops"
                                                                        ...
                                                                        <div class="panel panel-success"
                                                                            ...
                                                                            <div class="panel-heading" role="tab">
                                                                                <div class="row">
                                                                                    <div class="col-sm-8">
                                                                                        <h4 class="panel-title">
                                                                                            <a title="{$smarty.const.FIELD_OBJ_OP}: {$linea->indice}.{$objest->indice}.{$objop->indice}. {$objop->nombre}"
                                                                                               role="button"
                                                                                               data-toggle="collapse"
                                                                                               data-parent="#accordion_objops"
                                                                                               href="#{$linea->id}{$objest->id}{$objop->id}"
                                                                                               aria-expanded="false"
                                                                                               aria-controls="">
                                                                                                <i class="fa fa-bullseye fa-fw"></i> {$linea->indice}
                                                                                                .{$objest->indice}
                                                                                                .{$objop->indice}
                                                                                                . {$objop->nombre}
                                                                                            </a>
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <div class="progress">
                                                                                            <div class="progress-bar {if $objop->ejecucion|round:"2" < 25}progress-bar-danger{elseif $objop->ejecucion|round:"2" >= 25 && $objop->ejecucion|round:"2" < 75}progress-bar-warning{elseif $objop->ejecucion|round:"2" == 100}progress-bar-success{/if}"
                                                                                                 role="progressbar"
                                                                                                 aria-valuenow="{$objop->ejecucion|round:"2"}"
                                                                                                 aria-valuemin="0"
                                                                                                 aria-valuemax="100"
                                                                                                 style="min-width: 4em;width: {$objop->ejecucion|round:"2"}%;">
                                                                                                {$objop->ejecucion|round:"2"}
                                                                            ...
                                                                            <!-- /.panel-heading -->
                                                                            <div id="{$linea->id}{$objest->id}{$objop->id}"
                                                                                 class="panel-collapse collapse objop"
                                                                                 role="tabpanel" aria-labelledby=""
                                                                                 data-num_indic="{$objops_indicadores_correlacion[$objop->id]|@count + $objops_indicadores_control[$objop->id]|@count}">
                                                                                <div class="panel-group"
                                                                                    ...
                                                                                    {if $objops_indicadores_correlacion[$objop->id]}
                                                                                        <div class="panel panel-default">
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <div class="col-md-10">
                                                                                                            <i class="fa fa-dashboard fa-fw"></i><sub
                                                                                                                    class="fa fa-gear fa-fw"></sub> {$smarty.const.FIELD_INDICS}
                                                                                                            ({$smarty.const.FIELD_PROC}
                                                                                                            )
                                                                                                        </div>
                                                                                                        <!-- /.col-md-10 -->
                                                                                                        <div class="col-md-2">
                                                                                                            <span title="{$objop->nombre}: {$objops_indicadores_correlacion[$objop->id]|@count} {$smarty.const.FIELD_INDICS} ({$smarty.const.FIELD_PROC})"
                                                                                                                  class="badge">{$objops_indicadores_correlacion[$objop->id]|@count} {$smarty.const.FIELD_INDICS}</span>
                                                                                                        </div>
                                                                                                        <!-- /.col-md-2 -->
                                                                                                    </div>
                                                                                                    <!-- /.row -->
                                                                                            ...
                                                                                            <div class="panel-body">
                                                                                                <div id="carousel-correl-{$objop->id}"
                                                                                    ...
                                                                                    {if $objops_indicadores_control[$objop->id]}
                                                                                        <div class="panel panel-default">
                                                                                            <div class="panel-heading">
                                                                                                <div class="panel-title">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <!-- /.col-md-10 -->
                                                                                                        <div class="col-md-2">
                                                                                                            <span title="{$objop->nombre}: {$objops_indicadores_control[$objop->id]|@count} {$smarty.const.FIELD_INDICS} ({$smarty.const.TXT_CONTROL})"
                                                                                                                  class="badge">{$objops_indicadores_control[$objop->id]|@count} {$smarty.const.FIELD_INDICS}</span>
                                                                                                        </div>
                                                                                                        <!-- /.col-md-2 -->
                                                                                                    </div>
                                                                                                    <!-- /.row -->
                                                                                            ...
                                                                                            <!-- /.panel-heading -->
                                                                                            <div class="panel-body">
                                                                                                <div id="carousel-control-{$objop->id}"
                                                                                                     class="carousel slide"
                                                                                                     data-ride="carousel"
                                                                                                     data-interval="15000">
                                                                                                    <!-- Wrapper for slides -->
                                                                                                    ...
                                                                                                    <a class="left carousel-control"
                                                                                                       title="{$smarty.const.TXT_ANT}"
                                                                                                       href="#carousel-control-{$objop->id}"
                                                                                                       role="button"
                                                                                                       data-slide="prev">
                                                                                                        <span class="glyphicon glyphicon-chevron-left"
                                                                                                              aria-hidden="true"
                            ...
                            <div id="ejec_anyo" class="panel panel-red">
                                <div class="panel-heading">
                                    <span class="panel-title"><i
                                                class="fa fa-tasks fa-fw"></i> {$smarty.const.FIELD_EJECUCION}
                                        /{$smarty.const.FIELD_ANYO}: {$smarty.const.FIELD_PLAN} {$plan->anyo_inicio}
                                        - {($plan->anyo_inicio + $plan->duracion-1)}</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress">
                                                        <div class="progress-bar {if $ejecucion_anual[$i]|round:"2" < 25}progress-bar-danger{elseif $ejecucion_anual[$i]|round:"2" >= 25 && $ejecucion_anual[$i]|round:"2" < 75}progress-bar-warning{elseif $ejecucion_anual[$i]|round:"2" == 100}progress-bar-success{/if}"
                                                             role="progressbar"
                                                             aria-valuenow="{$ejecucion_anual[$i]|round:"2"}"
                                                             aria-valuemin="0" aria-valuemax="100"
                                                ...
                                                <td id="resultado_{$i}" style="width:50%">
                                                    <textarea class="form-control"
                                                              placeholder="{$smarty.const.TXT_RESUL}" rows="4"
                                                ...
                                                {if $_control}
                                                    <td style="white-space:nowrap" id="edicion_{$i}">
                                                        <a title="{$smarty.const.TXT_EDIT}"
                                                           ...
                                                           data-id_plan='{$plan->id}' data-anyo='{$i}'>
                                                            <i class="fa fa-pencil fa-fw"></i>
                                                        </a>
                                                    </td>
                                                {/if}
