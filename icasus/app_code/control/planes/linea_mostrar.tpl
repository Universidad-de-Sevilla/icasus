        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel"><i
                            class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_LINEA_BORRAR}: {$linea->indice}
                    . {$linea->nombre}</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a title="{$smarty.const.TXT_SI}" class="btn btn-success" name="borrar" id="borrar"
                   href="index.php?page=linea_borrar&id_entidad={$plan->id_entidad}&id_linea={$linea->id}"><i
    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation">
                <a href="#linea_ficha" title="{$smarty.const.TXT_FICHA}" aria-controls="{$smarty.const.TXT_FICHA}"
                   role="tab" data-toggle="tab"><i class="fa fa-folder fa-fw"></i> {$smarty.const.TXT_FICHA}</a>
            </li>
            <li role="presentation" class="active">
                <a href="#linea_objest" title="{$smarty.const.FIELD_OBJS_EST}"
            ...
            <li role="presentation">
                <a href="#linea_objop" title="{$smarty.const.FIELD_OBJS_OP}"
            ...
            <li role="presentation">
                <a href="#linea_res" title="{$smarty.const.TXT_SEGUIMIENTO}"
        ...
        <div class="tab-content">
            ...
            <!-- Ficha de la línea -->
            <div role="tabpanel" class="tab-pane" id="linea_ficha">
                <div class="row">
                    <!-- Datos de la línea -->
                    <div class="col-md-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="{$smarty.const.FIELD_PLAN} {$plan->anyo_inicio} - {($plan->anyo_inicio + $plan->duracion-1)}"
                                       href='index.php?page=plan_mostrar&id_plan={$plan->id}&id_entidad={$entidad->id}'>{$smarty.const.FIELD_PLAN} {$plan->anyo_inicio}
                                        - {$plan->anyo_inicio + $plan->duracion-1}</a>
                                </td>
                            </tr>
                            <tr>
                        ...
                        {if $_control}
                            <div id="botones_ficha" class="btn-toolbar hidden" role="toolbar" aria-label="">
                                <a title="{$smarty.const.TXT_LINEA_EDIT}" class="btn btn-default btn-danger"
                                ...
                                <a title="{$smarty.const.TXT_LINEA_BORRAR}" class="btn btn-default btn-danger"
                                   href='javascript:void(0)' data-toggle="modal"
                                   data-target="#dialogo_confirmar_borrado_linea">
            ...
            <div role="tabpanel" class="tab-pane active" id="linea_objest">
                <!-- Ejecucion -->
                <ul class="list-group" style="margin: 0;">
                    <li class="list-group-item list-group-item-info">
                        <div class="row">
                            <div class="col-sm-8 h4">
                                {$linea->indice}. {$linea->nombre}
                            </div>
                            <!-- /.col-sm-8 -->
                            <div class="col-sm-4">
                                <div class="progress">
                                ...
                                {if $_control}
                                    <td style="white-space:nowrap" id="edicion_{$i}">
                                        <a title="{$smarty.const.TXT_EDIT}"
                                           class="btn btn-default btn-xs btn-circle editar" data-id_linea='{$linea->id}'
                                           data-anyo='{$i}'>
                                            <i class="fa fa-pencil fa-fw"></i>
                                        </a>
                                    </td>
