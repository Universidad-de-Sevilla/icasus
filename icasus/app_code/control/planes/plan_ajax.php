...
// Archivo: planes/plan_ajax.php
// Tipo: controlador
// Desarrolladores: Juanan Ruiz (juanan@us.es), Jesus Martin Corredera (jjmc@us.es),
// Joaquín Valonero Zaera (tecnibus1@us.es)
//---------------------------------------------------------------------------------------------------
// Descripcion: Muestra los resúmenes y edita resultados de un plan estratégico
//---------------------------------------------------------------------------------------------------
...
$plantilla = 'planes/plan_ajax.tpl';
...
if ($modulo == 'grabar_resultado')
{
    ...
    $ejecucion = new Ejecucion();
    if (!($ejecucion->load("id_plan=$id_plan AND anyo=$anyo")))
    {
        $ejecucion->id_plan = $id_plan;
        $ejecucion->anyo = $anyo;
    }
...
if ($modulo == 'cancelar_resultado')
{
    ...
    if ($ejecucion_anual->Load("id_plan=$id_plan AND anyo=$anyo"))
    {
