    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation">
                <a href="#user_disp" title="{$smarty.const.TXT_USERS_ASIGNAR}" aria-controls="{$smarty.const.TXT_USERS_ASIGNAR}" role="tab" data-toggle="tab"><i class="fa fa-user-plus fa-fw"></i> {$smarty.const.TXT_USERS_ASIGNAR}</a>
            </li>
        </ul>
        <!-- /Nav tabs -->
        <br>
                                ...
                                <tbody>
                                    {foreach from=$usuarios item=usuario}
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-control chosen-select rol_usuario" data-id_usuario="{$usuario->id_usuario}" data-id_entidad="{$usuario->id_entidad}">
