...
<div class="row">
    <div class="col-lg-12">
        <h3 title="{$_nombre_pagina}" class="page-header">
            <i class="fa fa-gavel fa-fw"></i><sub class="fa fa-plus fa-fw"></sub> {$_nombre_pagina}
        </h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-12">
        <form action='index.php?page=derecho_grabar' method='post' id='formderecho' name='formderecho' 
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type='text' class="form-control" name='categoria' id='categoria' placeholder="{$smarty.const.FIELD_CAT}"/>
                </div>
            </div>
            <div class="form-group">
