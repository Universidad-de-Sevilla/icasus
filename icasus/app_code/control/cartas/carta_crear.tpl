...
<div class="row">
    <div class="col-lg-12">
        <h3 title="{$_nombre_pagina}" class="page-header">
            <i class="fa fa-map-o fa-fw"></i><sub class="fa fa-plus fa-fw"></sub> {$_nombre_pagina}
        </h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
        ...
        <form action='index.php?page=carta_grabar' method='post' id='formcarta' name='formcarta' 
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-8">
                    <div class="input-group date" data-provide="datepicker" data-date-language="es" data-date-autoclose="true" data-date-today-highlight="true">
                        ...
                        <input type='text' class="form-control" name='fecha' id='fecha' placeholder="{$smarty.const.FIELD_FECHA}" data-validar_fecha="validar_fecha" required/>
                    </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-8">
                    <a class="btn btn-danger" title="{$smarty.const.TXT_CANCEL}" href ='index.php?page=carta_listar&id_entidad={$entidad->id}'>
