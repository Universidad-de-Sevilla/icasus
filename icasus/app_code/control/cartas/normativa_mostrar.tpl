    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a title="{$smarty.const.TXT_SI}" class="btn btn-success" name="borrar" id="borrar" href="index.php?page=normativa_borrar&id_normativa={$normativa->id}&id_entidad={$normativa->carta->id_entidad}"><i
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="">
                            <div class="btn-group" role="group" aria-label="">
                                <a title="{$smarty.const.TXT_PRIMER} {$smarty.const.FIELD_NORMATIVA}" class="btn btn-danger btn-xs {if $indice == 0}disabled{/if}" href='index.php?page=normativa_mostrar&id_entidad={$entidad->id}&id_normativa={$normativas[0]->id}'>
                                    <i class="fa fa-step-backward fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ANT} {$smarty.const.FIELD_NORMATIVA}" class="btn btn-danger btn-xs {if $indice == 0}disabled{/if}" href='index.php?page=normativa_mostrar&id_entidad={$entidad->id}&id_normativa={$normativas[$indice-1]->id}'>
                                    <i class="fa fa-play fa-rotate-180 fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_SIG} {$smarty.const.FIELD_NORMATIVA}" class="btn btn-danger btn-xs {if $indice == (count($normativas)-1)}disabled{/if}" href='index.php?page=normativa_mostrar&id_entidad={$entidad->id}&id_normativa={$normativas[$indice+1]->id}'>
                                    <i class="fa fa-play fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ULTIMO} {$smarty.const.FIELD_NORMATIVA}" class="btn btn-danger btn-xs {if $indice == (count($normativas)-1)}disabled{/if}" href='index.php?page=normativa_mostrar&id_entidad={$entidad->id}&id_normativa={$normativas[(count($normativas)-1)]->id}'>
...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><a title="{$smarty.const.FIELD_NORMATIVAS}" href='index.php?page=carta_mostrar&id_carta={$carta->id}&id_entidad={$entidad->id}#carta_normativas'>{$smarty.const.FIELD_NORMATIVAS}</a></li>
    ...
    <div class="col-lg-12">
        ...
        {if $_control}
            <div id="botones_ficha" class="btn-toolbar hidden" role="toolbar" aria-label="">
                <a title="{$smarty.const.TXT_NORMATIVA_EDIT}" class="btn btn-default btn-danger" href="index.php?page=normativa_editar&id_normativa={$normativa->id}&id_entidad={$normativa->carta->id_entidad}">
                    <i class="fa fa-hand-paper-o fa-fw"></i><sub class="fa fa-pencil fa-fw"></sub>
                </a>
                <a title="{$smarty.const.TXT_NORMATIVA_BORRAR}" class="btn btn-default btn-danger" href='javascript:void(0)' data-toggle="modal" data-target="#dialogo_confirmar_borrado_normativa">
