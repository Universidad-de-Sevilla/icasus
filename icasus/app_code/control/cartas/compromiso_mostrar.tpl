        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">
                    <i class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_COMPROMISO_BORRAR}: C.{$compromiso->indice}. {$compromiso->nombre}</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a title="{$smarty.const.TXT_SI}" class="btn btn-success" name="borrar" id="borrar" href="index.php?page=compromiso_borrar&id_compromiso={$compromiso->id}&id_entidad={$entidad->id}"><i
...
<div class="row">
    <div class="col-lg-12">
        <h3 title="{$_nombre_pagina}" class="page-header">
            <div class="row">
                <div class="col-md-10">
                    <i class="fa fa-handshake-o fa-fw"></i> {$_nombre_pagina}
                </div>
                <!-- /.col-md-10 -->
                <!-- Navegación -->
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="">
                            <div class="btn-group" role="group" aria-label="">
                                <a title="{$smarty.const.TXT_PRIMER} {$smarty.const.FIELD_COMPROMISO}" class="btn btn-danger btn-xs {if $indice == 0}disabled{/if}" href='index.php?page=compromiso_mostrar&id_entidad={$entidad->id}&id_compromiso={$compromisos[0]->id}'>
                                    <i class="fa fa-step-backward fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ANT} {$smarty.const.FIELD_COMPROMISO}" class="btn btn-danger btn-xs {if $indice == 0}disabled{/if}" href='index.php?page=compromiso_mostrar&id_entidad={$entidad->id}&id_compromiso={$compromisos[$indice-1]->id}'>
                                    <i class="fa fa-play fa-rotate-180 fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_SIG} {$smarty.const.FIELD_COMPROMISO}" class="btn btn-danger btn-xs {if $indice == (count($compromisos)-1)}disabled{/if}" href='index.php?page=compromiso_mostrar&id_entidad={$entidad->id}&id_compromiso={$compromisos[$indice+1]->id}'>
                                    <i class="fa fa-play fa-fw"></i>
                                </a>
                                <a title="{$smarty.const.TXT_ULTIMO} {$smarty.const.FIELD_COMPROMISO}" class="btn btn-danger btn-xs {if $indice == (count($compromisos)-1)}disabled{/if}" href='index.php?page=compromiso_mostrar&id_entidad={$entidad->id}&id_compromiso={$compromisos[(count($compromisos)-1)]->id}'>
    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active">
                <a href="#compromiso_ficha" title="{$smarty.const.TXT_FICHA}" aria-controls="{$smarty.const.TXT_FICHA}" role="tab" data-toggle="tab"><i class="fa fa-folder fa-fw"></i> {$smarty.const.TXT_FICHA}</a>
            </li>
            <li role="presentation">
                <a href="#compromiso_indics" title="{$smarty.const.FIELD_INDICS}" aria-controls="{$smarty.const.FIELD_INDICS}" role="tab" data-toggle="tab"><i class="fa fa-dashboard fa-fw"></i> {$smarty.const.FIELD_INDICS}</a>
            </li>
        </ul>
        <!-- /Nav tabs -->
        <br>
                    ...
                    <div class="col-md-12">
                        ...
                        {if $_control}
                            <div id="botones_ficha" class="btn-toolbar hidden" role="toolbar" aria-label="">
                                <a title="{$smarty.const.TXT_COMPROMISO_EDIT}" class="btn btn-default btn-danger" href="index.php?page=compromiso_editar&id_compromiso={$compromiso->id}&id_entidad={$carta->id_entidad}">
                                    <i class="fa fa-handshake-o fa-fw"></i><sub class="fa fa-pencil fa-fw"></sub>
                                </a>
                                <a title="{$smarty.const.TXT_COMPROMISO_BORRAR}" class="btn btn-default btn-danger" href='javascript:void(0)' data-toggle="modal" data-target="#dialogo_confirmar_borrado_compromiso">
