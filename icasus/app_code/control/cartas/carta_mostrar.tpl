        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">
                    <i class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_CARTA_BORRAR}
            ...
            <div class="modal-footer">
                ...
                <a title="{$smarty.const.TXT_SI}" class="btn btn-success" name="borrar" id="borrar"
                   href="index.php?page=carta_borrar&id_carta={$carta->id}&id_entidad={$carta->id_entidad}"><i
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel"><i
                            class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_NORMATIVA_BORRAR}: <span
                            id="nombre_normativa"></span></h3>
            </div>
            <div class="modal-body">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h3 class="modal-title" id="myModalLabel"><i
                            class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_SERVICIO_BORRAR}: <span
                            id="nombre_servicio"></span></h3>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="dialogo_confirmar_borrado_derecho" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h3 class="modal-title" id="myModalLabel"><i
                            class="fa fa-trash fa-fw"></i> {$smarty.const.TXT_DERECHO_BORRAR}: <span
                            id="nombre_derecho"></span></h3>
            </div>
            <div class="modal-body">
                ...
                <div class="col-md-2">
                    ...
                    <div class="btn-toolbar" role="toolbar" aria-label="">
                        <div class="btn-group" role="group" aria-label="">
                            <a title="{$smarty.const.TXT_PRIMER} {$smarty.const.FIELD_CARTA}"
    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active">
                <a href="#carta_ficha" title="{$smarty.const.TXT_FICHA}" aria-controls="{$smarty.const.TXT_FICHA}"
                   role="tab" data-toggle="tab"><i class="fa fa-folder fa-fw"></i> {$smarty.const.TXT_FICHA}</a>
            </li>
            <li role="presentation">
                <a href="#carta_normativas" title="{$smarty.const.FIELD_NORMATIVAS}"
                   aria-controls="{$smarty.const.FIELD_NORMATIVAS}" role="tab" data-toggle="tab"><i
                            class="fa fa-hand-paper-o fa-fw"></i> {$smarty.const.FIELD_NORMATIVAS}</a>
            </li>
            <li role="presentation">
                <a href="#carta_servicios" title="{$smarty.const.FIELD_SERVICIOS}"
                   aria-controls="{$smarty.const.FIELD_SERVICIOS}" role="tab" data-toggle="tab"><i
                            class="fa fa-user-circle-o fa-fw"></i> {$smarty.const.FIELD_SERVICIOS}</a>
            </li>
            <li role="presentation">
                <a href="#carta_compromisos" title="{$smarty.const.FIELD_COMPROMISOS}"
            ...
            <li role="presentation">
                <a href="#carta_indics" title="{$smarty.const.FIELD_INDICS}"
            ...
            <li role="presentation">
                <a href="#carta_derechos" title="{$smarty.const.FIELD_DERECHOS}"
                   aria-controls="{$smarty.const.FIELD_DERECHOS}" role="tab" data-toggle="tab"><i
                            class="fa fa-gavel fa-fw"></i> {$smarty.const.FIELD_DERECHOS}</a>
            </li>
            <li role="presentation">
                <a href="#carta_archivos" title="{$smarty.const.TXT_ARCHIVOS}"
            ...
            <li role="presentation">
                <a href="#carta_res"
                   title="{$smarty.const.TXT_SEGUIMIENTO} ({$smarty.const.FIELD_SERVICIOS}, {$smarty.const.FIELD_COMPROMISOS}, {$smarty.const.FIELD_INDICS})"
                   aria-controls="{$smarty.const.TXT_SEGUIMIENTO} ({$smarty.const.FIELD_SERVICIOS}, {$smarty.const.FIELD_COMPROMISOS}, {$smarty.const.FIELD_INDICS})"
                        ...
                        {if $_control}
                            <div id="botones_ficha" class="btn-toolbar hidden" role="toolbar" aria-label="">
                                ...
                                <a title="{$smarty.const.TXT_CARTA_BORRAR}" class="btn btn-default btn-danger"
                                   ...
                                   data-target="#dialogo_confirmar_borrado_carta">
                                ...
                                {foreach from=$normativas item=normativa}
                                    <tr>
                                        <td><a title="{$smarty.const.TXT_FICHA}"
                                               href="index.php?page=normativa_mostrar&id_entidad={$carta->id_entidad}&id_normativa={$normativa->id}">{$normativa->nombre}</a>
                                        </td>
                                        <td>
                                            <a title="{$normativa->nombre}" href="{$normativa->enlace}"
                                               target="_blank">{$normativa->enlace}</a>
                                        </td>

                                        <td>
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_FICHA}"
                                               href="index.php?page=normativa_mostrar&id_entidad={$carta->id_entidad}&id_normativa={$normativa->id}">
                                                <i class="fa fa-folder fa-fw"></i>
                                            </a>
                                            {if $_control}
                                                <a class="btn btn-default btn-circle btn-xs"
                                                   title="{$smarty.const.TXT_EDIT}"
                                                   href="index.php?page=normativa_editar&id_entidad={$carta->id_entidad}&id_normativa={$normativa->id}">
                                                    <i class="fa fa-pencil fa-fw"></i>
                                                </a>
                                                <a class="btn btn-default btn-circle btn-xs"
                                                   title="{$smarty.const.TXT_NORMATIVA_BORRAR}"
                                                   href='javascript:void(0)' data-toggle="modal"
                                                   data-target="#dialogo_confirmar_borrado_normativa"
                                                   data-id_entidad="{$carta->id_entidad}"
                                                   data-nombre="{$normativa->nombre}"
                                                   data-id_normativa="{$normativa->id}">
                                                    <i class="fa fa-trash fa-fw"></i>
                                                </a>
                                            {/if}
                                        </td>
                                    ...
                                    <div class="btn-toolbar" role="toolbar" aria-label="">
                                        <div class="btn-group" role="group" aria-label="">
                                            <a class="btn btn-danger"
                                               href='index.php?page=normativa_crear&id_carta={$carta->id}&id_entidad={$carta->id_entidad}'
                                               title="{$smarty.const.TXT_NORMATIVA_CREAR}">
                                                <i class="fa fa-hand-paper-o fa-fw"></i><sub
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-default btn-circle btn-xs" title="{$smarty.const.TXT_FICHA}"
                                           href="index.php?page=servicio_mostrar&id_entidad={$carta->id_entidad}&id_servicio={$servicio->id}">
                                            <i class="fa fa-folder fa-fw"></i>
                                        </a>
                                        {if $_control}
                                            <a class="btn btn-default btn-circle btn-xs"
                                            ...
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_EDIT}"
                                               href="index.php?page=servicio_editar&id_entidad={$carta->id_entidad}&id_servicio={$servicio->id}">
                                                <i class="fa fa-pencil fa-fw"></i>
                                            </a>
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_SERVICIO_BORRAR}" href='javascript:void(0)'
                                               data-toggle="modal" data-target="#dialogo_confirmar_borrado_servicio"
                                               data-id_entidad="{$carta->id_entidad}"
                                               data-nombre="S.{$servicio->indice}. {$servicio->nombre}"
                                ...
                                <div class="btn-toolbar" role="toolbar" aria-label="">
                                    <div class="btn-group" role="group" aria-label="">
                                        <a class="btn btn-danger"
                                           href='index.php?page=servicio_crear&id_carta={$carta->id}&id_entidad={$carta->id_entidad}'
                                           title="{$smarty.const.TXT_SERVICIO_CREAR}">
                                            <i class="fa fa-user-circle-o fa-fw"></i><sub
                                                    class="fa fa-plus fa-fw"></sub>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <table id="tabla_objest" class="table datatable table-striped table-hover">
                            ...
                            {foreach $servicios as $serv}
                                {foreach from=$compromisos_servicios[$serv->id] item=compromiso}
                                    <tr>
                                        <td>
                                            <span class="label label-default">S.{$serv->indice}
                                                .C.{$compromiso->indice}</span>
                                        </td>
                                        <td>
                                            <a title="{$compromiso->nombre}: {$compromiso->descripcion|replace:"\r\n":" "}"
                                               href="index.php?page=compromiso_mostrar&id_entidad={$carta->id_entidad}&id_compromiso={$compromiso->id}">C.{$compromiso->indice}
                                                . {$compromiso->nombre}</a>
                                        </td>
                                        <td>
                                            <a title="{$serv->nombre}: {$serv->descripcion|replace:"\r\n":" "}"
                                               href="index.php?page=servicio_mostrar&id_entidad={$carta->id_entidad}&id_servicio={$serv->id}">S.{$serv->indice}
                                                . {$serv->nombre}</a>
                                        </td>
                                        <td>
                                            <a class="btn btn-default btn-circle btn-xs"
                                            ...
                                            {if $_control}
                                                ...
                                                <a class="btn btn-default btn-circle btn-xs"
                                                   title="{$smarty.const.TXT_COMPROMISO_BORRAR}"
                                                   href='javascript:void(0)' data-toggle="modal"
                                                ...
                                                <td>
                                                    {if $indicador->id_tipo_agregacion!= 0}
                                                        <i class="fa fa-sitemap fa-fw"
                                                           title="{$smarty.const.FIELD_AGREG}"></i>
                                                    {/if}
                                                </td>
                                                <td>
                        ...
                        <div class="table-responsive">
                            <table id="tabla_derechos" class="table datatable table-striped table-hover">
                                ...
                                {foreach from=$derechos item=derecho}
                                    <tr>
                                        <td><a title="{$smarty.const.TXT_FICHA}"
                                               href="index.php?page=derecho_mostrar&id_entidad={$carta->id_entidad}&id_derecho={$derecho->id}">{$derecho->nombre}</a>
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn btn-default btn-circle btn-xs"
                                               title="{$smarty.const.TXT_FICHA}"
                                               href="index.php?page=derecho_mostrar&id_entidad={$carta->id_entidad}&id_derecho={$derecho->id}">
                                                <i class="fa fa-folder fa-fw"></i>
                                            </a>
                                            {if $_control}
                                                <a class="btn btn-default btn-circle btn-xs"
                                                   title="{$smarty.const.TXT_EDIT}"
                                                   href="index.php?page=derecho_editar&id_entidad={$carta->id_entidad}&id_derecho={$derecho->id}">
                                                    <i class="fa fa-pencil fa-fw"></i>
                                                </a>
                                                <a class="btn btn-default btn-circle btn-xs"
                                                   title="{$smarty.const.TXT_NORMATIVA_BORRAR}"
                                                   href='javascript:void(0)' data-toggle="modal"
                                                   data-target="#dialogo_confirmar_borrado_derecho"
                                                   data-id_entidad="{$carta->id_entidad}"
                                                   data-nombre="{$derecho->nombre}" data-id_derecho="{$derecho->id}">
                                                    <i class="fa fa-trash fa-fw"></i>
                                                </a>
                                            {/if}
                                        </td>
            ...
            <div role="tabpanel" class="tab-pane" id="carta_archivos">
                ...
                {if $_control}
                    <div id="botones_archivo" class="btn-toolbar hidden" role="toolbar" aria-label="">
                        <div class="btn-group" role="group" aria-label="">
                            <a class="btn btn-danger"
                               href='index.php?page=archivo_gestionar&id_carta={$carta->id}&id_entidad={$entidad->id}'
                            ...
                            <div class="panel panel-danger" style="margin-top: 0;">
                                <div class="panel-heading" role="tab">
                                    <h4 class="panel-title">
                                        <a title="{$smarty.const.FIELD_SERVICIO}: S.{$servicio->indice}. {$servicio->nombre}"
                                           role="button" data-toggle="collapse" data-parent="#accordion_servicios"
                                           href="#{$servicio->id}" aria-expanded="false" aria-controls="">
                                            <i class="fa fa-user-circle-o fa-fw"></i> S.{$servicio->indice}
                                            . {$servicio->nombre}
                                        </a>
                                        <a class="panel-title pull-right" title="{$smarty.const.TXT_FICHA}"
                                           href="index.php?page=servicio_mostrar&id_servicio={$servicio->id}&id_entidad={$carta->id_entidad}">
                                            <i class="fa fa-folder fa-fw"></i>
                                        </a>
                                    </h4>
                                </div>
                                <!-- /.panel-heading -->
                                <div id="{$servicio->id}" class="panel-collapse collapse" role="tabpanel"
                                     aria-labelledby="">
                                    <div class="panel-group" id="accordion_compromisos" role="tablist"
                                        ...
                                        {if $compromisos_servicios[$servicio->id]}
                                            {foreach from=$compromisos_servicios[$servicio->id] item=compromiso}
                                                <div class="panel panel-warning" style="margin-top: 0;">
                                                    <div class="panel-heading" role="tab">
                                                        <h4 class="panel-title">
                                                            <a title="{$smarty.const.FIELD_COMPROMISO}: C.{$compromiso->indice}. {$compromiso->nombre}"
                                                               role="button" data-toggle="collapse"
                                                               data-parent="#accordion_compromisos"
                                                               href="#{$servicio->id}{$compromiso->id}"
                                                               aria-expanded="false" aria-controls="">
                                                                <i class="fa fa-handshake-o fa-fw"></i>
                                                                C.{$compromiso->indice}. {$compromiso->nombre}
                                                            </a>
                                                            <a class="panel-title pull-right"
                                                               title="{$smarty.const.TXT_FICHA}"
                                                               href="index.php?page=compromiso_mostrar&id_compromiso={$compromiso->id}&id_entidad={$carta->id_entidad}">
                                                                <i class="fa fa-folder fa-fw"></i>
                                                            </a>
                                                        </h4>
                                                    </div>
                                                ...
                                                <!-- /.panel-heading -->
                                                <div id="{$servicio->id}{$compromiso->id}"
                                                     class="panel-collapse collapse compromiso" role="tabpanel"
                                                     aria-labelledby=""
                                                     {if isset($compromiso_indicadores[$compromiso->id])}data-num_indic="{$compromiso_indicadores[$compromiso->id]|@count}{/if}">
                                                    {if isset($compromiso_indicadores[$compromiso->id])}
                                                        <div class="panel-body">
                                                            <div id="carousel-indics-{$compromiso->id}"
                                                                ...
                                                                <a class="left carousel-control"
                                                                   title="{$smarty.const.TXT_ANT}"
                                                                   href="#carousel-correl-{$objop->id}" role="button"
                                                                   data-slide="prev">
