...
<div class="row">
    <div class="col-lg-12">
        <h3 title="{$_nombre_pagina}" class="page-header">
            <i class="fa fa-hand-paper-o fa-fw"></i><sub class="fa fa-pencil fa-fw"></sub> {$_nombre_pagina}
        </h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><a title="{$smarty.const.FIELD_NORMATIVA}: {$normativa->nombre}" href='index.php?page=normativa_mostrar&id_entidad={$carta->id_entidad}&id_normativa={$normativa->id}'>{$normativa->nombre|truncate:30}</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <form action='index.php?page=normativa_grabar' method='post' id='formnormativa' name='formnormativa' 
              data-toggle="validator" class="form-horizontal">
            <input type="hidden" name="id_carta" value="{$carta->id}">
            <input type="hidden" name="id_normativa" value="{$normativa->id}">
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-8">
                    <input type='text' class="form-control" value="{$normativa->nombre}" name='nombre' id='nombre' placeholder="{$smarty.const.FIELD_NOMBRE}" required/>
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="form-group has-feedback">
                <label for="enlace" class="col-sm-2 control-label"><i title="{$smarty.const.MSG_CAMPO_REQ}" class="fa fa-asterisk fa-fw"></i> URL</label>
                <div class="col-sm-8">
                    <input type='url' name='enlace' id='enlace' class="form-control" placeholder="URL" value="{$normativa->enlace}" required/>
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-8">
                    <a class="btn btn-danger" title="{$smarty.const.TXT_CANCEL}" href ='index.php?page=normativa_mostrar&id_normativa={$normativa->id}&id_entidad={$carta->id_entidad}'>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" id="myModalLabel"><i class="fa fa-hand-paper-o fa-fw"></i><sub class="fa fa-pencil fa-fw"></sub> {$smarty.const.TXT_NORMATIVA_EDIT}: {$normativa->nombre}</h3>
                        </div>
                        <div class="modal-body">
                            <p>{$smarty.const.MSG_NORMATIVA_CONFIRM_EDITAR}</p>
                        </div>
