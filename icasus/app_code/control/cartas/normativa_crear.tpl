...
<div class="row">
    <div class="col-lg-12">
        <h3 title="{$_nombre_pagina}" class="page-header">
            <i class="fa fa-hand-paper-o fa-fw"></i><sub class="fa fa-plus fa-fw"></sub> {$_nombre_pagina}
        </h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-12">
        <form action='index.php?page=normativa_grabar' method='post' id='formnormativa' name='formnormativa' 
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-8">
                    <input type='url' name='enlace' id='enlace' class="form-control" placeholder="URL" required/>
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
