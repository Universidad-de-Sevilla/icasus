        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a title="{$smarty.const.TXT_SI}" class="btn btn-success" name="borrar" id="borrar"
                   href="index.php?page=derecho_borrar&id_derecho={$derecho->id}&id_entidad={$derecho->carta->id_entidad}"><i
...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><a title="{$smarty.const.FIELD_DERECHOS}"
                   href='index.php?page=carta_mostrar&id_carta={$carta->id}&id_entidad={$entidad->id}#carta_derechos'>{$smarty.const.FIELD_DERECHOS}</a>
            </li>
    ...
    <div class="col-lg-12">
        ...
        {if $_control}
            <div id="botones_ficha" class="btn-toolbar hidden" role="toolbar" aria-label="">
                <a title="{$smarty.const.TXT_DERECHO_EDIT}" class="btn btn-default btn-danger"
                   href="index.php?page=derecho_editar&id_derecho={$derecho->id}&id_entidad={$derecho->carta->id_entidad}">
                    <i class="fa fa-gavel fa-fw"></i><sub class="fa fa-pencil fa-fw"></sub>
                </a>
                <a title="{$smarty.const.TXT_DERECHO_BORRAR}" class="btn btn-default btn-danger"
                   href='javascript:void(0)' data-toggle="modal" data-target="#dialogo_confirmar_borrado_derecho">
