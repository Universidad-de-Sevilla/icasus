                            ...
                            {foreach from=$entidades_usuario item=entidad}
                                <tr>
                                    ...
                                    <td>{if $entidad->principal}<i title="{$smarty.const.TXT_UNID_PRINCIPAL}"
                                            ...
                                            data-id_usuario="{$_usuario->id}" data-id_user_unid="{$entidad->id}"
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-default btn-circle btn-xs" title="{$smarty.const.TXT_CONTROL}"
                                ...
                                <tr>
                                    <td>
                                        <a title="{$cuadro->nombre}"
                                           href="index.php?page=cuadro_mostrar&id_cuadro={$cuadro->id}&id_entidad={$cuadro->id_entidad}">{$cuadro->nombre}</a>
                                    </td>
                                    <td><a title="{$smarty.const.TXT_FICHA}"
                                    ...
                                    <td style="white-space:nowrap">
                                        <a class="btn btn-default btn-circle btn-xs" title="{$smarty.const.TXT_VER}"
                                           href="index.php?page=cuadro_mostrar&id_cuadro={$cuadro->id}&id_entidad={$cuadro->id_entidad}"><i
                                                    class="fa fa-th fa-fw"></i></a>
                                        <a class="btn btn-default btn-circle btn-xs" title="{$smarty.const.TXT_EDIT}"
