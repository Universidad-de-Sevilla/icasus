...
<h2>Editando valor</h2>
<p><a href='index.php?page=indicador_datos&id_indicador={$valor->id_indicador}'><img 
	src='theme/usevilla/iconos/chart_bar.gif' alt='icono' /> Volver al indicador</a></p> 
<form method='post' action='index.php?page=valor_grabar' id='formvalor' name='formvalor' class='datos'>
	...
	<p><label for='dato_valor'>Valor </label> &nbsp; <span class='grey'>(requerido)</span><br />
	<input type='text' name='dato_valor' id='dato_valor' class='inp' value='{$valor->valor}' /></p>

	<p><label for='fecha_recogida'>Fecha obtenci&oacute;n </label> &nbsp;<span class='grey'>(requerido)</span><br />
	...
	<p><label for='objetivo_estrategico'>Objetivo Pactado</label> &nbsp; <span class='grey'>(requerido)</span><br />
	<input type='text' name='objetivo_estrategico' id='objetivo_estrategico' class='inp'
	value='{$valor->objetivo_estrategico}' /></p>

	<p><label for='objetivo_carta'>Objetivo Carta de Servicio</label> &nbsp; 
	<span class='grey'>(requerido)</span><br />
	<input type='text' name='objetivo_carta' id='objetivo' class='inp' value='{$valor->objetivo_carta}' /></p>
	
	<p><label for='observaciones'>Observaciones</label><br />
	<textarea name='observaciones' id='observaciones' class='inp'>{$valor->observaciones}</textarea></p>

	<p><input type='button' class='submit-btn' value='Enviar' name='indicador_submit' onclick='javascript:valor_validar();' /></p>
</form>
