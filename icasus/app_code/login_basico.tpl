<div style='width: 335px; float:left; margin:5px;'>
    <img src='theme/usevilla/cuadromando.png' alt='icono grafica lineal' align='right' /><p><b>{$smarty.const.TXT_ICASUS}</b> {$smarty.const.TXT_LOGIN_BASICO_PARTE1}
        <a href="http://www.us.es/">{$smarty.const.TXT_UNIVERSIDAD}</a>.</p>

    <p>{$smarty.const.TXT_LOGIN_BASICO_PARTE2}</p>

    <p>{$smarty.const.TXT_LOGIN_BASICO_PARTE3} <a href="http://www.r2h2.us.es/">{$smarty.const.TXT_AREA_REC_HUM} </a> 
        {$smarty.const.TXT_LOGIN_BASICO_PARTE4} <a href="http://forja.rediris.es/projects/icasus/">{$smarty.const.TXT_SOFT_LIBRE}</a>.</p>

    <p>{$smarty.const.TXT_LOGIN_BASICO_PARTE5}<a href="http://icasus.us.es/upload/ayuda/icasus_manual_breve.pdf"> {$smarty.const.TXT_MANUAL} </a>
        {$smarty.const.TXT_LOGIN_BASICO_PARTE6}</p>
