        ...
        <div class="btn-toolbar" role="toolbar" aria-label="">
            {if !$indice}
                <div class="btn-group" role="group" aria-label="">
                    <a title="{$smarty.const.TXT_VOLVER_INDICE}" class="btn btn-default btn-danger" href='index.php?page=pagina_mostrar&alias=indice'><i class="fa fa-file-text fa-fw"></i><sub class="fa fa-arrow-left fa-fw"></sub></a>
                </div>
            {/if}
            {if $admin}
                <div class="btn-group" role="group" aria-label="">
