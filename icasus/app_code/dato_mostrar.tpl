...
<div class="row">
    <div class="col-lg-12">
        <div class="btn-toolbar" role="toolbar" aria-label="">
            ...
            <div class="btn-group" role="group" aria-label="">    
                <a title="{$smarty.const.FIELD_MEDICIONES}" class="btn btn-default btn-danger" href='index.php?page=medicion_listar&id_dato={$dato->id}&id_entidad={$dato->id_entidad}'>
                                    ...
                                    {if $dato_subunidades}
                                        <ul>
                                            {foreach $dato_subunidades as $dato_subunidad}
                                                <li>
                                                    <a href="index.php?page=entidad_mostrar&id_entidad={$dato_subunidad->entidad->id}">{$dato_subunidad->entidad->etiqueta}</a>
                                                </li>
                                            {/foreach}
                                        </ul>
                                    {else}
