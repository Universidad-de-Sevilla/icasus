    ...
    <div class="col-lg-12">
        <div class="btn-toolbar" role="toolbar" aria-label="">
            <div class="btn-group" role="group" aria-label="">    
                <a title="{$smarty.const.TXT_CONSULT}" class="btn btn-default btn-danger" href="index.php?page=consulta_avanzada&id_entidad={$entidad->id}">
                    <i class="fa fa-commenting fa-fw"></i> {$smarty.const.TXT_CONSULT}
                </a>
            </div>
            {if $_control}
                <div class="btn-group" role="group" aria-label="">
                    <a title="{$smarty.const.TXT_CONTROL}" class="btn btn-default btn-danger" href="index.php?page=control&modulo=inicio&id_entidad={$entidad->id}">
