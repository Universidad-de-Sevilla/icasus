...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li><a title="{$smarty.const.FIELD_LINEA} {$linea->indice}. {$linea->nombre}" href='index.php?page=linea_mostrar&id_plan={$plan->id}&id_linea={$linea->id}'>{$smarty.const.FIELD_LINEA} {$linea->indice}. {$linea->nombre}</a></li>
    ...
    <div class="col-lg-12">
        <form action='index.php?page=linea_grabar' method='post' id='formlinea' name='formlinea' 
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-8">
                    <input type='number' class="form-control" name='indice' id='indice' value="{$linea->indice}" min="1" placeholder="{$smarty.const.FIELD_INDICE}" required/>
